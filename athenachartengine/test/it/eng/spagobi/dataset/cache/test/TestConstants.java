...
public class TestConstants {
	...
	public static String RESOURCE_PATH = workspaceFolder + "/SpagoBIChartEngine/test/resources/";
	public static String WEBCONTENT_PATH = workspaceFolder + "/SpagoBIChartEngine/WebContent";
