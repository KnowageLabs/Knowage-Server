...
import it.eng.spago.base.SourceBeanContentHandler;
import it.eng.spago.base.SourceBeanException;
import it.eng.spago.base.StringXMLSerializer;
...
public class SourceBean extends AbstractXMLObject implements CloneableObject, Serializable {
	...
	public void updAttribute(String key, Object value) throws SourceBeanException {
		...
		if (key.indexOf('.') != -1) {
			...
			TracerSingleton.log(Constants.NOME_MODULO, TracerSingleton.WARNING, "SourceBean::updAttribute: attributo [" + searchKey + "] non è un SourceBean");
