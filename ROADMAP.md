...
* **New Dashboard**: The graphical interface has been completely redesigned to improve usability and response times. Additionally, the following features have been added:
 ...
 - **Thematization Management**: Define new themes through a dedicated tool and share them across dashboards to streamline the creation of consistent dashboards.
 ...
 - **Contextual Hel**p: Add a dedicated section to each widget to host documentation supporting end users in understanding the displayed data.
 ...
 - **Multi-Device Dashboards**: Allow users to access and interact with data on various devices—computers, tablets, and smartphones—ensuring optimized and consistent visualization. These dashboards provide a smooth and responsive experience, enabling informed decision-making anywhere.
 - **Selector Widget** Enhancements:
   ...
   - Advanced Cache Management: Optimize cache handling to improve selector performance.
...
* **Dossier Evolutio**n: Automatically generate templates based on added documents for more efficient and dynamic management.
...
* **Guided Tour**: An interactive tutorial upon first access to KNOWAGE for easy orientation.
