 ...
 */
Ext.define("Sbi.chart.designer.ChartConfigurationHeatmapTooltip", {
...
//		this.colorPicker.on("colorRendered", function(actualColorField) {         	       			
//			if (actualColorField == "heatmapTooltipColor") {
//				var fontColor = globalScope.viewModel.data.configModel.get('tipColor');
//
//				if (fontColor && fontColor != "" && fontColor != "transparent") {
//					globalScope.colorPicker.items.items[0].labelEl
//						.update(LN('sbi.chartengine.configuration.color')+":");
//				} else {
//					globalScope.colorPicker.items.items[0].labelEl
//						.update(LN('sbi.chartengine.configuration.color') +  ":");
//				}
