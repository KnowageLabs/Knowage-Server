...
-->
<script type="text/javascript" src="${pageContext.request.contextPath}/js/src/angular/tools/scripts/controller/chartExecutionController.js"></script>

<!-- 
	Configuration that is needed for our Angular application - all module that we need for it (e.g. sbiModule).
-->
<script type="text/javascript" src="${pageContext.request.contextPath}/js/src/angular/tools/scripts/config/chartExecutionConfig.js"></script>

<!-- 
	All directives that our application will use (for now, an empty array).
-->
<script type="text/javascript" src="${pageContext.request.contextPath}/js/src/angular/tools/scripts/directives/chartExecutionDirectives.js"></script>

<!-- The configuration properties container for the rendering of the charts. (danristo) -->
<script type="text/javascript" src="${pageContext.request.contextPath}/js/src/angular/commons/Settings.js"></script>