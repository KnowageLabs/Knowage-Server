...
public class RWidget {
	...
	static protected Logger logger = Logger.getLogger(RWidget.class);

	@POST
	@Path("/view")
	@Consumes(MediaType.APPLICATION_JSON)
	public String view(@PathParam("document_id") Integer documentId, HashMap<String, String> params) {
		logger.debug("IN");
	...
	private String getRCodeFromTemplate(String template) {
