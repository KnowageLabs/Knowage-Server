...
public class CombinedCategoryBar extends LinkableBar {
	...
	public DatasetMap calculateValue() throws Exception {
		...
		lineNoShapeSeries1 = new ArrayList<String>();
		lineNoShapeSeries2 = new ArrayList<String>();
	...
	public void configureChart(SourceBean content) {
		...
		if (draws != null) {
			...
			for (Iterator iterator = atts.iterator(); iterator.hasNext();) {
				...
				serieName = object.getKey();
				serieDraw = (String) object.getValue();
...
//		Create Renderers!
		...
		LineAndShapeRenderer lineRenderer1 = useLinesRenderers ? new LineAndShapeRenderer() : null;
		LineAndShapeRenderer lineRenderer2 = useLinesRenderers ? new LineAndShapeRenderer() : null;
		...
		if (enableToolTips) {
			MyCategoryToolTipGenerator generatorToolTip = new MyCategoryToolTipGenerator(freeToolTips, seriesTooltip,
					categoriesTooltip, seriesCaptions);
