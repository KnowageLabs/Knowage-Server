...
public class OverlaidBarLine extends LinkableBar {
	...
	private static final Logger LOGGER = Logger.getLogger(OverlaidBarLine.class);
	...
	boolean stackedBarRenderer1 = false;
	boolean stackedBarRenderer2 = false;
	...
	public JFreeChart createChart(DatasetMap datasets) {
		...
		if (useBars) {
			...
			if (stackedBarRenderer1) {
				barRenderer = new StackedBarRenderer();
			} else {
				barRenderer = new BarRenderer();
			}

			CategoryItemRenderer barRenderer2 = null;

			if (stackedBarRenderer2) {
