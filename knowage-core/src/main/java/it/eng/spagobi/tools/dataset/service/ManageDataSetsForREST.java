...
public class ManageDataSetsForREST {
    ...
    private SolrDataSet manageSolrDataSet(boolean savingDataset, JSONObject config, JSONObject json) throws JSONException {
        ...
        SolrDataSet res = solrType.equalsIgnoreCase(SolrDataSetConstants.TYPE.DOCUMENTS.name()) ? new SolrDataSet(config, parametersMap) : new FacetSolrDataSet(config, parametersMap);
        return res;
    }
