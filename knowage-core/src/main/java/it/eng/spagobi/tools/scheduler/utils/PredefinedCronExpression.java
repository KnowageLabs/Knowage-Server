...
public enum PredefinedCronExpression {
	...
	EVERY_1_MIN("EVERY_1_MIN", "0 0/1 * 1/1 * ? *"), EVERY_10_MINS("EVERY_10_MINS", "0 0/10 * 1/1 * ? *"), EVERY_15_MINS("EVERY_15_MINS",
			"0 0/15 * 1/1 * ? *"), EVERY_20_MINS("EVERY_20_MINS", "0 0/20 * 1/1 * ? *"), EVERY_30_MINS("EVERY_30_MINS", "0 0/30 * 1/1 * ? *"), HOURLY("HOURLY",
					"0 0 0/1 1/1 * ? *"), DAILY("DAILY",
