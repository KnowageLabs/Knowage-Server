 ...
 * @author Marco Cortella (marco.cortella@eng.it) This Class encapsulates the crossTab The publics methods are: - CrossTab(IDataStore dataStore,
 *         CrosstabDefinition crosstabDefinition) that builds the crossTab (headers structure and data) - getJSONCrossTab() that returns the JSON representation
 *         of the crosstab
 */
