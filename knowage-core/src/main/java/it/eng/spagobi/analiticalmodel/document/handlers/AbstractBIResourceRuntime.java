...
public abstract class AbstractBIResourceRuntime<T extends AbstractDriver> {
	...
	private static Logger logger = Logger.getLogger(AbstractBIResourceRuntime.class);
	...
	protected AbstractBIResourceRuntime(IEngUserProfile userProfile, Locale locale) {
		this.userProfile = userProfile;
		this.locale = locale;
	}
