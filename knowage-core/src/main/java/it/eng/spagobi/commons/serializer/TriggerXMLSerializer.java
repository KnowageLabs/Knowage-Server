...
public class TriggerXMLSerializer implements Serializer {
	...
	public Object serialize(Object o, Locale locale) throws SerializationException {
		...
		try {
			...
			DateTime triggerStardDateTime = new DateTime(triggerStartTime);

			result.append(" " + TRIGGER_ZONED_START_TIME + "=\"" + formatter.print(triggerStardDateTime) + "\"");
			if (triggerEndTime != null) {
				DateTime triggerEndDateTime = new DateTime(triggerEndTime);

				result.append(" " + TRIGGER_ZONED_END_TIME + "=\"" + formatter.print(triggerEndDateTime) + "\"");
			}
