...
ALTER TABLE SBI_FEDERATION_DEFINITION ADD CONSTRAINT NAME_UNIQUE UNIQUE (NAME);
ALTER TABLE SBI_FEDERATION_DEFINITION ADD CONSTRAINT LABEL_UNIQUE UNIQUE (LABEL);
