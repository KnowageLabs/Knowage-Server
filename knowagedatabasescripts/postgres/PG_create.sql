...
CREATE TABLE SBI_LOV (
       ...
       ORGANIZATION         VARCHAR(20),
       DATASET_ID			INTEGER,
       CONSTRAINT XAK1SBI_LOV UNIQUE  (LABEL, NAME, ORGANIZATION),
       PRIMARY KEY (LOV_ID)
) WITHOUT OIDS;
...
CREATE TABLE SBI_OBJECTS (
       ...
       META_VERSION         VARCHAR(100),
       ORGANIZATION         VARCHAR(20),
       CONSTRAINT XAK1SBI_OBJECTS UNIQUE  (LABEL, NAME, ORGANIZATION),
...
CREATE TABLE SBI_PARAMETERS (
	...
	META_VERSION        VARCHAR(100),
	ORGANIZATION        VARCHAR(20),
	CONSTRAINT XAK1SBI_PARAMETERS UNIQUE  (LABEL, NAME, ORGANIZATION),
	PRIMARY KEY (PAR_ID)
) WITHOUT OIDS;
