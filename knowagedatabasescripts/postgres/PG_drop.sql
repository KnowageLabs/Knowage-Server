...
DROP TABLE IF EXISTS SBI_ORGANIZATION_ENGINE CASCADE;
...
DROP TABLE IF EXISTS SBI_META_DATASET_TABLE_RELATIONS CASCADE ;
DROP TABLE IF EXISTS SBI_META_DOCUMENT_TABLE_RELATIONS CASCADE ;
