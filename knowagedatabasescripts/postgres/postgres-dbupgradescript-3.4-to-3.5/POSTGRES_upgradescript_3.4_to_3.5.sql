...
ALTER TABLE SBI_I18N_MESSAGES DROP CONSTRAINT sbi_i18n_messages_pkey;
...
update QRTZ_JOB_DETAILS set JOB_GROUP = 'SPAGOBI/' || JOB_GROUP;
update QRTZ_TRIGGERS set JOB_GROUP = 'SPAGOBI/' || JOB_GROUP;
update QRTZ_JOB_LISTENERS set JOB_GROUP = 'SPAGOBI/' || JOB_GROUP;
update QRTZ_FIRED_TRIGGERS set JOB_GROUP = 'SPAGOBI/' || JOB_GROUP;
commit;
