...
ALTER TABLE SBI_DATA_SET ADD FEDERATION_ID INTEGER NULL;
ALTER TABLE SBI_DATA_SET MODIFY FEDERATION_ID DEFAULT NULL;
...
ALTER TABLE SBI_PARUSE ADD VALUE_SELECTION VARCHAR2(20);
ALTER TABLE SBI_PARUSE MODIFY VALUE_SELECTION DEFAULT NULL;
ALTER TABLE SBI_PARUSE ADD SELECTED_LAYER VARCHAR2(100);
ALTER TABLE SBI_PARUSE MODIFY SELECTED_LAYER DEFAULT NULL;
ALTER TABLE SBI_PARUSE ADD SELECTED_LAYER_PROP VARCHAR2(40);
ALTER TABLE SBI_PARUSE MODIFY SELECTED_LAYER_PROP DEFAULT NULL;

ALTER TABLE SBI_PARAMETERS ADD VALUE_SELECTION VARCHAR2(20);
ALTER TABLE SBI_PARAMETERS MODIFY VALUE_SELECTION DEFAULT NULL;
ALTER TABLE SBI_PARAMETERS ADD SELECTED_LAYER VARCHAR2(100);
ALTER TABLE SBI_PARAMETERS MODIFY SELECTED_LAYER DEFAULT NULL;
ALTER TABLE SBI_PARAMETERS ADD SELECTED_LAYER_PROP VARCHAR2(40);
ALTER TABLE SBI_PARAMETERS MODIFY SELECTED_LAYER_PROP DEFAULT NULL;
