...
ALTER TABLE SBI_PARUSE
	ADD COLUMN VALUE_SELECTION VARCHAR2(20) DEFAULT NULL AFTER MULTIVALUE_FLAG,
	ADD COLUMN SELECTED_LAYER VARCHAR2(100) DEFAULT NULL AFTER VALUE_SELECTION,
	ADD COLUMN SELECTED_LAYER_PROP VARCHAR2(40) DEFAULT NULL AFTER SELECTED_LAYER;

ALTER TABLE SBI_PARAMETERS 
	ADD COLUMN VALUE_SELECTION VARCHAR2(20) DEFAULT NULL AFTER TEMPORAL_FLAG,
	ADD COLUMN SELECTED_LAYER VARCHAR2(100) DEFAULT NULL AFTER VALUE_SELECTION,
	ADD COLUMN SELECTED_LAYER_PROP VARCHAR2(40) DEFAULT NULL AFTER SELECTED_LAYER;
