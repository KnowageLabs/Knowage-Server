...
ALTER TABLE SBI_CACHE_ITEM
ADD NAME VARCHAR(50) default '' NOT NULL ;

ALTER TABLE SBI_DASHBOARD_THEME
ADD IS_DEFAULT SMALLINT DEFAULT 0 NOT NULL;
...
DELETE FROM SBI_AUTHORIZATIONS_ROLES WHERE AUTHORIZATION_ID IN (SELECT ID FROM SBI_AUTHORIZATIONS WHERE NAME='ENABLE_TO_PRINT');
