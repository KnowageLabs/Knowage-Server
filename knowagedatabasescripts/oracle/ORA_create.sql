...
ALTER TABLE SBI_EXT_ROLES_DS_CATEGORY 		ADD CONSTRAINT FK_SB_EXT_ROLES_DS_CAT_1 	FOREIGN KEY (EXT_ROLE_ID) 			REFERENCES SBI_EXT_ROLES (EXT_ROLE_ID);
ALTER TABLE SBI_EXT_ROLES_DS_CATEGORY 		ADD CONSTRAINT FK_SB_EXT_ROLES_DS_CAT_2 	FOREIGN KEY (CATEGORY_ID) 			REFERENCES SBI_DOMAINS (VALUE_ID);
