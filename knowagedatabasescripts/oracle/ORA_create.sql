...
CREATE TABLE SBI_NEWS (
	...
	CATEGORY_ID INTEGER  DEFAULT NULL,
	PRIMARY KEY (ID),
	CONSTRAINT VALUE_ID FOREIGN KEY (CATEGORY_ID) REFERENCES sbi_domains (VALUE_ID)  
) 	
...
CREATE TABLE SBI_NEWS_READ (
	...
	ORGANIZATION varchar(20) DEFAULT NULL,
	PRIMARY KEY (ID),
	CONSTRAINT fk_news_id FOREIGN KEY (NEWS_ID) REFERENCES SBI_NEWS (ID) 
) 
...
CREATE TABLE SBI_NEWS_ROLES (
	...
	CONSTRAINT EXT_ROLE_ID FOREIGN KEY (EXT_ROLE_ID) REFERENCES SBI_EXT_ROLES (EXT_ROLE_ID), 
	CONSTRAINT NEWS_ID FOREIGN KEY (NEWS_ID) REFERENCES SBI_NEWS (ID) 
) 
