...
ALTER TABLE SBI_FUNCTION_INPUT_VARIABLE 	ADD CONSTRAINT FK_FUNCTION_INPUT_VARIABLES_1  	FOREIGN KEY (FUNCTION_UUID)			REFERENCES SBI_CATALOG_FUNCTION(FUNCTION_UUID);
ALTER TABLE SBI_FUNCTION_INPUT_COLUMN 		ADD CONSTRAINT FK_FUNCTION_INPUT_COLUMNS_1  	FOREIGN KEY (FUNCTION_UUID)			REFERENCES SBI_CATALOG_FUNCTION(FUNCTION_UUID);
ALTER TABLE SBI_FUNCTION_OUTPUT_COLUMN 		ADD CONSTRAINT FK_FUNCTION_OUTPUT_COLUMNS_1  	FOREIGN KEY (FUNCTION_UUID)			REFERENCES SBI_CATALOG_FUNCTION(FUNCTION_UUID);
