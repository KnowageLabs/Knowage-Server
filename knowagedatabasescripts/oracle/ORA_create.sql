...
CREATE UNIQUE INDEX SBI_FED_DEF_NAME_UNIQUE ON SBI_FEDERATION_DEFINITION(NAME ASC);
CREATE UNIQUE INDEX SBI_FED_DEF_LABEL_UNIQUE ON SBI_FEDERATION_DEFINITION(LABEL ASC);
