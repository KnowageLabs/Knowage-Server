...
ALTER TABLE SBI_CROSS_NAVIGATION ADD COLUMN DESCRIPTION VARCHAR2(200) NULL DEFAULT NULL,
ALTER TABLE SBI_CROSS_NAVIGATION ADD COLUMN BREADCRUMB VARCHAR2(200) NULL DEFAULT NULL;