...
ALTER TABLE SBI_ATTRIBUTE ADD COLUMN AFTER ATTRIBUTE_ID (LOV_ID INTEGER NULL,ALLOW_USER SMALLINT(6) DEFAULT '1',MULTIVALUE SMALLINT(6) DEFAULT '0',SYNTAX SMALLINT(6) NULL,
