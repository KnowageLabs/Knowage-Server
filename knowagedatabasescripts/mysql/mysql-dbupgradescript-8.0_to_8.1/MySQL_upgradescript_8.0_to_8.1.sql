...
INNER JOIN 
	SBI_CATEGORY c ON c.CODE = d.VALUE_CD and c.ORGANIZATION = ds.ORGANIZATION
SET 
	ds.CATEGORY_ID = c.ID;
COMMIT;
...
INNER JOIN 
	SBI_CATEGORY c ON c.CODE = d.VALUE_CD and c.ORGANIZATION = mm.ORGANIZATION
SET 
	mm.CATEGORY_ID = c.ID;
COMMIT;
...
INNER JOIN 
	SBI_CATEGORY c ON c.CODE = d.VALUE_CD and c.ORGANIZATION = gl.ORGANIZATION
SET 
...
INNER JOIN 
	SBI_CATEGORY c ON c.CODE = d.VALUE_CD and c.ORGANIZATION = kk.ORGANIZATION
SET 
	kk.CATEGORY_ID = c.ID;
COMMIT;
...
INNER JOIN 
	SBI_CATEGORY c ON c.CODE = d.VALUE_CD and c.ORGANIZATION = kt.ORGANIZATION
SET 
	kt.CATEGORY_ID = c.ID;
COMMIT;
...
INNER JOIN 
	SBI_CATEGORY c ON c.CODE = d.VALUE_CD and c.ORGANIZATION = kro.ORGANIZATION
SET 
