...
DROP TABLE IF EXISTS JBPM_ACTION CASCADE;
DROP TABLE IF EXISTS JBPM_BYTEARRAY CASCADE;
DROP TABLE IF EXISTS JBPM_BYTEBLOCK CASCADE;
DROP TABLE IF EXISTS JBPM_COMMENT CASCADE;
DROP TABLE IF EXISTS JBPM_DECISIONCONDITIONS CASCADE;
DROP TABLE IF EXISTS JBPM_DELEGATION CASCADE;
DROP TABLE IF EXISTS JBPM_EVENT CASCADE;
DROP TABLE IF EXISTS JBPM_EXCEPTIONHANDLER CASCADE;
DROP TABLE IF EXISTS JBPM_ID_GROUP CASCADE;
DROP TABLE IF EXISTS JBPM_ID_MEMBERSHIP CASCADE;
DROP TABLE IF EXISTS JBPM_ID_PERMISSIONS CASCADE;
DROP TABLE IF EXISTS JBPM_ID_USER CASCADE;
DROP TABLE IF EXISTS JBPM_LOG CASCADE;
DROP TABLE IF EXISTS JBPM_MESSAGE CASCADE;
DROP TABLE IF EXISTS JBPM_MODULEDEFINITION CASCADE;
DROP TABLE IF EXISTS JBPM_MODULEINSTANCE CASCADE;
DROP TABLE IF EXISTS JBPM_NODE CASCADE;
DROP TABLE IF EXISTS JBPM_POOLEDACTOR CASCADE;
DROP TABLE IF EXISTS JBPM_PROCESSDEFINITION CASCADE;
DROP TABLE IF EXISTS JBPM_PROCESSINSTANCE CASCADE;
DROP TABLE IF EXISTS JBPM_RUNTIMEACTION CASCADE;
DROP TABLE IF EXISTS JBPM_SWIMLANE CASCADE;
DROP TABLE IF EXISTS JBPM_SWIMLANEINSTANCE CASCADE;
DROP TABLE IF EXISTS JBPM_TASK CASCADE;
DROP TABLE IF EXISTS JBPM_TASKACTORPOOL CASCADE;
DROP TABLE IF EXISTS JBPM_TASKCONTROLLER CASCADE;
DROP TABLE IF EXISTS JBPM_TASKINSTANCE CASCADE;
DROP TABLE IF EXISTS JBPM_TIMER CASCADE;
DROP TABLE IF EXISTS JBPM_TOKEN CASCADE;
DROP TABLE IF EXISTS JBPM_TOKENVARIABLEMAP CASCADE;
DROP TABLE IF EXISTS JBPM_TRANSITION CASCADE;
DROP TABLE IF EXISTS JBPM_VARIABLEACCESS CASCADE;
DROP TABLE IF EXISTS JBPM_VARIABLEINSTANCE CASCADE;
...
DROP TABLE IF EXISTS QRTZ_JOB_LISTENERS CASCADE;
...
DROP TABLE IF EXISTS QRTZ_TRIGGER_LISTENERS CASCADE;
...
DROP TABLE IF EXISTS SBI_DOSSIER_BIN_TEMP CASCADE;
DROP TABLE IF EXISTS SBI_DOSSIER_PRES CASCADE;
DROP TABLE IF EXISTS SBI_DOSSIER_TEMP CASCADE;
...
DROP TABLE IF EXISTS TWITTER_ACCOUNTS_TO_MONITOR CASCADE;
DROP TABLE IF EXISTS TWITTER_DATA CASCADE;
DROP TABLE IF EXISTS TWITTER_LINKS_TO_MONITOR CASCADE;
DROP TABLE IF EXISTS TWITTER_LINK_TO_MONITOR_CATEGORY CASCADE;
DROP TABLE IF EXISTS TWITTER_MONITOR_SCHEDULER CASCADE;
DROP TABLE IF EXISTS TWITTER_SEARCH CASCADE;
DROP TABLE IF EXISTS TWITTER_SEARCH_SCHEDULER CASCADE;
DROP TABLE IF EXISTS TWITTER_SENTIMENT CASCADE;
DROP TABLE IF EXISTS TWITTER_USERS CASCADE;
SET FOREIGN_KEY_CHECKS=1 CASCADE;