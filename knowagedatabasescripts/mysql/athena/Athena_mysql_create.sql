...
ALTER TABLE SBI_KPI_RULE                    ADD UNIQUE KEY UNIQUE_IDX_01_SBI_KPI_RULE       (NAME, ORGANIZATION);
ALTER TABLE SBI_KPI_KPI                     ADD UNIQUE KEY UNIQUE_IDX_01_SBI_KPI_KPI        (NAME, ORGANIZATION);
