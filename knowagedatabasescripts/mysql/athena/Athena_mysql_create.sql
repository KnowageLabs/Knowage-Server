...
CREATE TABLE SBI_KPI_EXECUTION_FILTER (
  ...
  PRIMARY KEY (PLACEHOLDER_ID,EXECUTION_ID)
) ENGINE=INNODB ;
...
ALTER TABLE SBI_KPI_SCORECARD ADD CONSTRAINT FK_01_SBI_KPI_SCORECARD FOREIGN KEY (TYPE_ID) REFERENCES SBI_DOMAINS (VALUE_ID);
