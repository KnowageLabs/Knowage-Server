...
ALTER TABLE `KNOWAGE_MASTER`.`SBI_META_MODELS` ADD TABLE_PREFIX_LIKE VARCHAR(4000) NULL;
-- Column to define prefixes to use in not like conditions
ALTER TABLE `KNOWAGE_MASTER`.`SBI_META_MODELS` ADD TABLE_PREFIX_NOT_LIKE VARCHAR(4000) NULL;