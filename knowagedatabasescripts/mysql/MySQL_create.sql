...
ALTER TABLE SBI_META_DS_BC 					ADD CONSTRAINT FK_SBI_META_DS_BC_1					FOREIGN KEY (DS_ID) 				REFERENCES SBI_DATA_SET(DS_ID);
...
ALTER TABLE SBI_META_OBJ_DS 				ADD CONSTRAINT FK_SBI_META_OBJ_DS_1 				FOREIGN KEY (DS_ID) 				REFERENCES SBI_DATA_SET(DS_ID);
ALTER TABLE SBI_META_OBJ_DS 				ADD CONSTRAINT FK_SBI_META_OBJ_DS_2 				FOREIGN KEY (OBJ_ID) 				REFERENCES SBI_OBJECTS(BIOBJ_ID);
ALTER TABLE SBI_META_DS_TABLE 				ADD CONSTRAINT FK_SBI_META_DS_TABLE_1 				FOREIGN KEY (DS_ID) 				REFERENCES SBI_DATA_SET(DS_ID);
ALTER TABLE SBI_META_DS_TABLE 				ADD CONSTRAINT FK_SBI_META_DS_TABLE_2 				FOREIGN KEY (TABLE_ID) 				REFERENCES SBI_META_TABLE(TABLE_ID);
ALTER TABLE SBI_META_OBJ_TABLE 				ADD CONSTRAINT FK_SBI_META_OBJ_TABLE_1 				FOREIGN KEY (OBJ_ID) 				REFERENCES SBI_OBJECTS(BIOBJ_ID);
ALTER TABLE SBI_META_OBJ_TABLE 				ADD CONSTRAINT FK_SBI_META_OBJ_TABLE_2 				FOREIGN KEY (TABLE_ID) 				REFERENCES SBI_META_TABLE(TABLE_ID);
