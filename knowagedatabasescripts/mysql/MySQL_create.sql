...
CREATE TABLE SBI_FUNCTION_INPUT_DATASET (
  ...
  SBI_VERSION_DE 		VARCHAR(10) NULL DEFAULT NULL, 
  ORGANIZATION 			VARCHAR(20) NULL DEFAULT  NULL,
  PRIMARY KEY (FUNCTION_ID, DS_ID/*, VERSION_NUM, ORGANIZATION*/)
  ) ENGINE=InnoDB;  
...
ALTER TABLE SBI_FUNCTION_INPUT_DATASET 		ADD CONSTRAINT FK_FUNCTION_INPUT_DATASETS_1 		FOREIGN KEY ( DS_ID ) 				REFERENCES SBI_DATA_SET ( DS_ID ) 			 ON DELETE  RESTRICT ON UPDATE  RESTRICT;
