...
CREATE TABLE `SBI_VIEW_HIERARCHY` (
  ...
  KEY `FK_SBI_VIEW_HIERARCHY_1` (`ORGANIZATION`,`PARENT_ID`),
  CONSTRAINT `FK_SBI_VIEW_HIERARCHY_1` FOREIGN KEY (`ORGANIZATION`, `PARENT_ID`) REFERENCES `SBI_VIEW_HIERARCHY` (`ORGANIZATION`, `ID`) ON UPDATE CASCADE
);
...
CREATE TABLE `SBI_VIEW` (
  ...
  `ORGANIZATION`      VARCHAR(20)  NOT NULL,
  PRIMARY KEY (`ORGANIZATION`,`ID`),
  KEY `FK_SBI_VIEW_1` (`ORGANIZATION`,`VIEW_HIERARCHY_ID`),
  KEY `FK_SBI_VIEW_2` (`BIOBJ_ID`),
  CONSTRAINT `FK_SBI_VIEW_1` FOREIGN KEY (`ORGANIZATION`, `VIEW_HIERARCHY_ID`) REFERENCES `SBI_VIEW_HIERARCHY` (`ORGANIZATION`, `ID`) ON UPDATE CASCADE,
  CONSTRAINT `FK_SBI_VIEW_2` FOREIGN KEY (`BIOBJ_ID`)                          REFERENCES `SBI_OBJECTS`        (`BIOBJ_ID`)           ON UPDATE CASCADE
);
...
CREATE TABLE `SBI_VIEW_FOR_DOC` (
  ...
  `ORGANIZATION`      VARCHAR(20)  NOT NULL,
  PRIMARY KEY (`ORGANIZATION`,`ID`),
  KEY `FK_SBI_VIEW_FOR_DOC_1` (`ORGANIZATION`,`VIEW_HIERARCHY_ID`),
  KEY `FK_SBI_VIEW_FOR_DOC_2` (`BIOBJ_ID`),
  CONSTRAINT `FK_SBI_VIEW_FOR_DOC_1` FOREIGN KEY (`ORGANIZATION`, `VIEW_HIERARCHY_ID`) REFERENCES `SBI_VIEW_HIERARCHY` (`ORGANIZATION`, `ID`) ON UPDATE CASCADE,
  CONSTRAINT `FK_SBI_VIEW_FOR_DOC_2` FOREIGN KEY (`BIOBJ_ID`)                          REFERENCES `SBI_OBJECTS`        (`BIOBJ_ID`)           ON UPDATE CASCADE
);
