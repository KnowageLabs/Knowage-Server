...
ALTER TABLE SBI_FEDERATION_DEFINITION 		ADD UNIQUE INDEX NAME_UNIQUE (NAME ASC, ORGANIZATION ASC);
ALTER TABLE SBI_FEDERATION_DEFINITION 		ADD UNIQUE INDEX LABEL_UNIQUE (LABEL ASC, ORGANIZATION ASC);
