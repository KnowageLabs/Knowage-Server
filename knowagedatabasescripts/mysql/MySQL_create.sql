...
CREATE TABLE SBI_NEWS_ROLES (
  ...
  CONSTRAINT EXT_ROLE_ID FOREIGN KEY (EXT_ROLE_ID) REFERENCES SBI_EXT_ROLES (EXT_ROLE_ID) ON DELETE CASCADE ON UPDATE NO ACTION,
  CONSTRAINT NEWS_ID FOREIGN KEY (NEWS_ID) REFERENCES SBI_NEWS (ID) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=InnoDB;


  -- 12.02.2019 Marko Kostic-- 

ALTER TABLE SBI_NEWS DROP FOREIGN KEY VALUE_ID;
...
ALTER TABLE SBI_NEWS_READ DROP FOREIGN KEY fk_news_id;
ALTER TABLE SBI_NEWS_READ CHANGE COLUMN id ID INT(11) NOT NULL ,CHANGE COLUMN USER USER_ID VARCHAR(100) NOT NULL ;
...
ALTER TABLE SBI_NEWS_ROLES DROP FOREIGN KEY EXT_ROLE_ID;
ALTER TABLE SBI_NEWS_ROLES DROP FOREIGN KEY NEWS_ID;
