...
DROP TABLE IF EXISTS SBI_HOMEPAGE_ROLE CASCADE;

DROP TABLE IF EXISTS SBI_HOMEPAGE CASCADE;
...
DROP TABLE IF EXISTS SBI_ES;

DROP TABLE IF EXISTS SBI_CATEGORY CASCADE;

DROP TABLE IF EXISTS SBI_VIEW_HIERARCHY CASCADE;
DROP TABLE IF EXISTS SBI_VIEW CASCADE;
DROP TABLE IF EXISTS SBI_VIEW_FOR_DOC CASCADE;

DROP TABLE IF EXISTS SBI_DASHBOARD_THEME CASCADE;
