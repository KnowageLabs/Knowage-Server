...
ALTER TABLE SBI_META_MODELS
	...
	CREATE MEMORY TABLE SBI_OBJ_DATA_SET (BIOBJ_DS_ID INTEGER NOT NULL, BIOBJ_ID INTEGER NOT NULL, DS_ID INTEGER NOT NULL, IS_DETAIL BOOLEAN DEFAULT FALSE, USER_IN VARCHAR(100) NOT NULL, USER_UP VARCHAR(100) DEFAULT NULL, USER_DE VARCHAR(100) DEFAULT NULL, TIME_IN TIMESTAMP, TIME_UP TIMESTAMP NULL DEFAULT NULL, TIME_DE TIMESTAMP NULL DEFAULT NULL, SBI_VERSION_IN VARCHAR(10) DEFAULT NULL, SBI_VERSION_UP VARCHAR(10) DEFAULT NULL, SBI_VERSION_DE VARCHAR(10) DEFAULT NULL, META_VERSION VARCHAR(100) DEFAULT NULL, ORGANIZATION VARCHAR(20) DEFAULT NULL, CONSTRAINT XAK1SBI_OBJ_DATA_SET UNIQUE (BIOBJ_ID ,DS_ID, ORGANIZATION), PRIMARY KEY (BIOBJ_DS_ID))
	
	ALTER TABLE SBI_OBJ_DATA_SET CONSTRAINT FK_SBI_OBJ_DATA_SET FOREIGN KEY(BIOBJ_ID) REFERENCES SBI_OBJECTS (BIOBJ_ID)
    ...
    , current_timestamp
    from
    (select distinct ROWNUM() rownum, PRODUCT_TYPE_ID from SBI_PRODUCT_TYPE) pt;
    commit;
