...
update hibernate_sequences set next_val=(select ifnull(max(ID),0)+1 from SBI_HOMEPAGE) where sequence_name='SBI_HOMEPAGE';
...
update hibernate_sequences set next_val=(select ifnull(max(SOURCE_ID),0)+1 from SBI_META_SOURCE)  where sequence_name='SBI_META_SOURCE';
update hibernate_sequences set next_val=(select ifnull(max(TABLE_ID),0)+1 from SBI_META_TABLE)  where sequence_name='SBI_META_TABLE';
update hibernate_sequences set next_val=(select ifnull(max(COLUMN_ID),0)+1 from SBI_META_TABLE_COLUMN) where sequence_name='SBI_META_TABLE_COLUMN';
update hibernate_sequences set next_val=(select ifnull(max(BC_ID),0)+1 from SBI_META_BC)  where sequence_name='SBI_META_BC';
update hibernate_sequences set next_val=(select ifnull(max(ATTRIBUTE_ID),0)+1 from SBI_META_BC_ATTRIBUTE)  where sequence_name='SBI_META_BC_ATTRIBUTE';
update hibernate_sequences set next_val=(select ifnull(max(JOB_ID),0)+1 from SBI_META_JOB) where sequence_name='SBI_META_JOB';
