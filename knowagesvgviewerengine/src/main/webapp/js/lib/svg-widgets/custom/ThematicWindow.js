...
ThematicWindow.prototype = new Window(); // Set up the prototype chain.
ThematicWindow.prototype.constructor = ThematicWindow; // Set the constructor attribute to Author.
...
ThematicWindow.prototype.createContent = function() {
  ...
  labelsEl = document.createElementNS(Utils.svgNS,"g");
  this.applyAttributes(labelsEl, {
    'id' : 'windowMainGroupthematic'
    , 'display' : 'inherit'
  });    
  windowContent.appendChild(labelsEl);    
  
  buttonsEl = document.createElementNS(Utils.svgNS,"g");
  this.applyAttributes(buttonsEl, {
    'id' : 'radioButtons'
    , 'display' : 'inherit'
  });    
...
ThematicWindow.prototype.applyAttributes = function(o, c, defaults){
    if(defaults){
...
ThematicWindow.prototype.eventHandler = function(id, evtType) { 
