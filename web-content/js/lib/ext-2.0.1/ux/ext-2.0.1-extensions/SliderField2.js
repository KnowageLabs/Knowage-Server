...
/**
  * @class Ext.form.SliderField2
  * @extends Ext.form.Field
  * Slider form field.
  * @constructor
  * Creates a new SliderField2
  * @param {Object} config Configuration options
  */
Ext.form.SliderField2 = Ext.extend(Ext.form.Field, {
        defaultAutoCreate : {tag:'input', type:'hidden'},

        // private
        initComponent : function() {
                Ext.form.SliderField2.superclass.initComponent.call(this);
        ...
        onRender: function(ct, position) {
                Ext.form.SliderField2.superclass.onRender.call(this, ct, position);
        ...
        afterRender: function() {
                Ext.form.SliderField2.superclass.afterRender.call(this);
...
Ext.reg('sliderfield2', Ext.form.SliderField2);
// end of file
