...
Ext.define('Ext.ux.FontColorField', {
    extend: 'Ext.form.field.Trigger',
    alias: 'widget.fontcolorfield',
    ...
    markInvalid : function( msg ) {
        Ext.ux.FontColorField.superclass.markInvalid.call(this, msg);
    ...
    setValue : function(hex){
        Ext.ux.FontColorField.superclass.setValue.call(this, hex);
        this.setColor(hex);
    },
    ...
    setColor : function(hex) {
    	if(hex !== undefined && hex !== null && hex !== ''){
            ...
            Ext.ux.FontColorField.superclass.setFieldStyle.call(this, {
