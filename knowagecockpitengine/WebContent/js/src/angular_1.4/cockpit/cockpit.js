...
var cockpitApp= angular.module("cockpitModule",['ngMaterial','sbiModule','gridster','file_upload','ngWYSIWYG','angular_table','cockpit_angular_table','color.picker','dndLists','chartRendererModule','accessible_angular_table']);
