...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/src/angular_1.4/tools/commons/angular-list-detail/angularListDetail.js"></script>
 ...
 <!-- angular-gridster-->
<script type="text/javascript" src="${pageContext.request.contextPath}/js/lib/angular/angular-gridster/angular-gridster.min.js"></script>
<link rel="stylesheet" href="${pageContext.request.contextPath}/js/lib/angular/angular-gridster/angular-gridster.min.css">
...
<!--  wysiwyg -->
<script type="text/javascript" src="${pageContext.request.contextPath}/js/lib/angular/ngWYSIWYG/wysiwyg.min.js"></script>	
