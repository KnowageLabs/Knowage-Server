...
<title>Cockpit engine</title>
	...
	<body class="kn-cockpit " id="kn-cockpit" ng-class="{'disableanimation':sbiModule_device.browser.name!='chrome'}" md-no-ink ng-controller="cockpitMasterControllerWrapper" layout="column" ng-style="cockpitBackgroundStyle">
