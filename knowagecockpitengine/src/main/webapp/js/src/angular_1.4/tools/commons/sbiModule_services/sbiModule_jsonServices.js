...
angular.module("sbiModule").service("sbiModule_jsonServices",function(sbiModule_config){

	this.observe=function(myobj){
		return jsonpatch.observe( myobj );
	}

	this.unobserve=function(myobj,observe){
		return jsonpatch.unobserve( myobj ,observe );
	}

	this.generate=function(observer){
		return jsonpatch.generate( observer );
	}

	this.compare=function(objA, objB){
		return jsonpatch.compare( objA, objB );
	}

	this.validate=function(patches, obj){
