...
.directive('angularTimePicker', function(sbiModule_config) {
  return {
    templateUrl: sbiModule_config.dynamicResourcesEnginePath + '/angular_1.4/tools/commons/angular-time-picker/angular-time-picker.html',
