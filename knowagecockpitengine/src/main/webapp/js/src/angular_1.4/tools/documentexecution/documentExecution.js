	  ...
	  */
		...
		$scope.rankDocument = function() {
			...
			$mdDialog.show({
				...
				templateUrl:sbiModule_config.dynamicResourcesEnginePath+'/angular_1.4/tools/documentbrowser/template/documentRank.html',
				scope:$scope,
				preserveScope: true,
		...
		$scope.copyLinkHTML = function(embedHTML){
			...
			.then(function(response, status, headers, config) {
				...
				$mdDialog.show({
					...
					//flex: 80,
					templateUrl: sbiModule_config.dynamicResourcesEnginePath+"/angular_1.4/tools/documentexecution/templates/publicExecutionUrl.html",
...
//				}
		...
		$scope.noteDocument = function() {
			...
			$mdDialog.show({
				...
				templateUrl:sbiModule_config.dynamicResourcesEnginePath+'/angular_1.4/tools/documentbrowser/template/documentNote.html',
				scope:$scope,
				preserveScope: true,
				clickOutsideToClose:true
			})
