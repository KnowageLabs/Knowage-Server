					...
					if(actualDs!=undefined){
						...
						angular.forEach(selectedColumnsDs,function(widgetColumn){
							...
							for(var i = 0; i < actualDs.metadata.fieldsMeta.length; i++){
								if(actualDs.metadata.fieldsMeta[i].name == widgetColumn.name || actualDs.metadata.fieldsMeta[i].alias == widgetColumn.name || widgetColumn.formula || widgetColumn.boundFunction){
