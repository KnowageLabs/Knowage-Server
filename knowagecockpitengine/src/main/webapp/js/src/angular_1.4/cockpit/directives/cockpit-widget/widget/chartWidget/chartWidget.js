			    	  ...
			    	  var changeDatasetFunction=function(dsId){
			    		  ...
			    		  if(ds){
			    			...
			    			for(var z in $scope.localModel.content.columnSelectedOfDataset){
			    				for(var c in $scope.localModel.columnSelectedOfDatasetAggregations){
			    					if (($scope.localModel.content.columnSelectedOfDatasetAggregations[c].name == $scope.localModel.content.columnSelectedOfDataset[z].name) && $scope.localModel.content.columnSelectedOfDataset[z].aggregationSelected != $scope.localModel.content.columnSelectedOfDatasetAggregations[c].aggregationSelected) {
