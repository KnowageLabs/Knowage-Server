...
.directive('expanderBox',function() {
	return {
		...
		"{{title}}" +
		"</span>" +
		"<i style=\"position:absolute;right:5px;top:2px;\"  ng-if=\"expanded\" class=\"material-icons\">expand_less</i>	<i  style=\"position:absolute;right:5px;top:2px;\" ng-if=\"!expanded\" class=\"material-icons\">expand_more</i>" +
		"</md-toolbar><md-content layout-padding  ng-show=\"expanded\"><div ng-transclude></div></md-content> " 
		,
