<div layout-fill ng-controller="frequencyController">
	...
	<md-content class="h100"> <md-input-container
		class="md-block"> <label>{{translate.load("scheduler.schedname","component_scheduler_messages")}}:</label>
	<input ng-model="frequency.name" name={{translate.load(
		"scheduler.schedname","component_scheduler_messages")}} required
		maxlength="100" ng-maxlength="100" md-maxlength="100"
		ng-disabled="activityEventCtrl.disableName"> </md-input-container> <md-input-container
		...
		<div ng-if="frequency.selectInterval=='month'" layout="row">
			<div layout="column" layout-wrap layout-align="center center">
				...
				<div layout="row" class="alignedCheckbox"
					...
					<md-select aria-label="aria-label" ng-model="frequency.value.month"
						style="margin:0px;" multiple='true'> <md-option
