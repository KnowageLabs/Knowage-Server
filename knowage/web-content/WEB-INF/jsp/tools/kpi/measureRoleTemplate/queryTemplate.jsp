<div layout="column" layout-wrap layout-fill ng-controller="measureRoleQueryController">
    <md-input-container>
        ...
        <md-select ng-model="currentMeasure.selectedDatasource">
    ...
    <md-whiteframe ng-if="detailProperty.dataSourcesIsSelected" class="md-whiteframe-2dp relative" layout-margin flex  >
		<div ui-codemirror="{ onLoad : codemirrorLoaded }" class="absolute" layout-fill ui-codemirror-opts="codemirrorOptions" ng-model=currentMeasure.query></div> 
     </md-whiteframe>
</div>