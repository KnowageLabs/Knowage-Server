...
<body class="bodyStyle">
	...
	<div ng-controller="Controller " layout="column" layout-wrap layout-fill>
			...
			<md-toolbar style="font:Roboto; padding:14px;background:#3b678c;font-size:18px !important;text:#ffffff" >
			...
			<div layout="row" layout-wrap>
			<div flex=55 ng-show="documents.length!=0"><h4>{{translate.load("sbi.templatemanagemenent.secondmessage");}}</h4></div>
