...
<!-- TODO using correct message -->
	<div ng-controller="importExportController " layout="column" layout-fill layout-wrap class="contentdemoBasicUsage" >		
	      		...
	      		<md-content ng-controller="exportController">
	         		<div ng-if="flags.waitExport" layout="column" layout-padding layout-align="space-around center">
						...
						<h3 ng-if="flags.viewDownload" class="md-body-2">
									...
									<md-button ng-click="downloadFile()">{{translate.load("Sbi.download","component_impexp_messages");}}  {{downloadedFileName}}.zip</md-button>
									<br>
						...
						<div  layout="column"  layout-padding layout-wrap >
							<div layout="row" layout-wrap style=" width:100%;">
		       				...
		       				<div layout-padding layout-gt-sm="row" layout-align-gt-sm="start center" layout-sm="column" layuout-align-sm ="start start">
