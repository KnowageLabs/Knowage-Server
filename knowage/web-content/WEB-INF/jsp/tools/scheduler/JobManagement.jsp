...
<body class="bodyStyle kn-jobManagement">
	<angular-list-detail ng-controller="Controller as ctrl" show-detail="ctrl.showDetail" id="angularListDetail">
		...
		<detail label='ctrl.getDetailTitle()'
			...
			<form name="forms.jobDetailForm" class="wordForm md-padding" novalidate>
			<div>
				<div flex="100">
					<md-input-container class="small counter" ng-show="ctrl.selectedJob.NEWJOB">
						<label>{{translate.load("sbi.generic.name")}}</label>
						<input class="input_class" ng-model="ctrl.selectedJob.jobName" required maxlength="80" ng-maxlength="80" md-maxlength="80">
					</md-input-container>
					<md-input-container class="small counter">
						<label>{{translate.load("sbi.generic.descr")}}</label>
						<input class="input_class" ng-model="ctrl.selectedJob.jobDescription" required maxlength="120" ng-maxlength="120" md-maxlength="120">
					</md-input-container>
				</div>
			</div>
