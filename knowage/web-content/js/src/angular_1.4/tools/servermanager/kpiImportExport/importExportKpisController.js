...
app.controller('kpiImportExportController', [ "sbiModule_download",
		"sbiModule_translate", "sbiModule_restServices", "$scope", "$mdDialog",
		"$mdToast", kpiImportExportFuncController ]);
...
app.controller('kpiImportController', [ 'sbiModule_download',
		...
		"importExportDocumentModule_importConf", kpiImportFuncController ]);


// --- CONTROLLERS --------------------------------------------------------------

function kpiImportExportFuncController(sbiModule_download, sbiModule_translate,
	...
	$scope.loadAllKpis = function() {
		sbiModule_restServices.promiseGet("1.0/kpi", "listKpi").then(
				function(response) {
...
function kpiImportFuncController(sbiModule_download, sbiModule_device, $scope,
