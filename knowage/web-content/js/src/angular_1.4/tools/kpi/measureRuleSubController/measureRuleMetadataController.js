angular.module('measureRuleManager').controller('measureRuleMetadataController', [ '$scope','sbiModule_translate' ,'sbiModule_restServices','sbiModule_messaging',measureRuleMetadataControllerFunction ]);

function measureRuleMetadataControllerFunction($scope,sbiModule_translate,sbiModule_restServices,sbiModule_messaging){
