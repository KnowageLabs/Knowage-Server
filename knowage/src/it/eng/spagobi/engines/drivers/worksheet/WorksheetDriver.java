...
public class WorksheetDriver extends AbstractDriver implements IEngineDriver {
	...
	public String updateWorksheetTemplate(String workSheetDef, String workSheetQuery, String smartFilterValues, String originalWorksheetTempl)
	...
	public String composeWorksheetTemplate(String workSheetDef, String workSheetQuery, String smartFilterValues, String originalQbeTempl)
			throws SourceBeanException {
		SourceBean templateSB = new SourceBean(TAG_WORKSHEET);
		templateSB.setAttribute(ATTRIBUTE_VERSION, CURRENT_VERSION);
			...
			if (((UserProfile) profile).isSchedulerUser(userId)) {
				...
				if (parameters.get("outputType") != null) {
					...
					if (outputType.equalsIgnoreCase("PDF"))
						mimeType = EXPORT_MIME_TYPE_PDF;
					else if (outputType.equalsIgnoreCase("XLS"))
						mimeType = EXPORT_MIME_TYPE_XLS;
					else { // default is XLS
					}
