...
public class FullKpiValueComputation {

	private KpiParametrization parameters;
	private KpiDriver engine;

	static transient Logger logger = Logger.getLogger(FullKpiValueComputation.class);
	...
	public FullKpiValueComputation(KpiDriver kpiVisualizationDriver) {
		this.parameters = kpiVisualizationDriver.parameters;
		this.engine = kpiVisualizationDriver;
	}
