...
<div layout="column">
   ...
   <div class="importDocWithoutLicense kn-warningContainer" layout="column" layout-wrap ng-if="IEDConf.objects && IEDConf.objects.notImportable.length!=0">
      ...
      <div layout="row" layout-align="center center">
         <div class="kn-warning" flex="60">
            {{translate.load('SBISet.importexport.oneOrMoreNotImportableDocs','component_impexp_messages');}}
         </div>
      </div>
      <md-list layout-padding class="centerText  ">
         <md-list-item class="md-3-line" ng-repeat="item in  IEDConf.objects.notImportable">
            <div class="md-list-item-text" layout="row" layout-wrap>
               ...
               <div flex="50">
                  <b>{{item.engine.label}}</b>
                  <h4>{{item.engine.name}}</h4>
                  <p>
   ...
   <md-content flex layout="column">
      <div layout="column" layout-wrap ng-if="IEDConf.summary.SbiObjects.length!=0">
         <md-subheader class="md-primary">{{translate.load('SBISet.importexport.importableDocuments','component_impexp_messages');}}</md-subheader>
         <md-list layout-padding class="centerText  ">
