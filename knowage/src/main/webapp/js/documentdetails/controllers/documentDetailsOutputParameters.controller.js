...
angular
        ...
        .controller('DocumentDetailsOutputController',[ 'DocumentService', 'resourceService', '$location',  'sbiModule_restServices', 'sbiModule_translate', '$scope', 'sbiModule_messaging', '$mdDialog',
        										function(DocumentService, resourceService, $location, sbiModule_restServices, sbiModule_translate, $scope, sbiModule_messaging, $mdDialog){
              ...
              documentService.changedOutputParameters = self.listOfOutputParameters;
              ...
              self.removeOutputParameterFromList = function(index) {            	              	  
            	  documentService.outputParametersForDeleting.push(self.listOfOutputParameters[index]);
