<div flex layout-align="start" class="parametersSidenav">
	...
	<div ng-if="parameter.typeCode=='MAN_IN' && parameter.valueSelection=='map_in' && parameter.showOnPanel=='true'" layout="column">
	 	<div layout="row" layout-align="start">
	 		<label ng-class="parameter.showMapDriver && showRequiredFieldMessage(parameter) ? 'requiredField' : 'norequiredField'" ng-style="{'font-style': isEmpty(parameter.dependsOn) ? '' : 'italic'}">{{i18n.getI18n(parameter.label)}}
