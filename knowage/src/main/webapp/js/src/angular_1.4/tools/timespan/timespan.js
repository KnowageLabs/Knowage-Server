...
app.controller('Controller', [ "sbiModule_translate", "sbiModule_restServices", "$scope", "$mdDialog", "$mdToast","sbiModule_messaging","sbiModule_config","sbiModule_dateServices", behavior ]);

function behavior(sbiModule_translate, sbiModule_restServices, $scope, $mdDialog, $mdToast,sbiModule_messaging,sbiModule_config,sbiModule_dateServices) {
	ctrl = this;
	...
	ctrl.parseDateTemp = function(date){
		result = "";
		if(date == "d/m/Y"){
			result = "dd/MM/yyyy";
		}
	...
	ctrl.addInterval = function(from, to) {
		if(from && to){
			if(ctrl.selectedItem.type=='temporal'){
				...
				var fLocalized = sbiModule_dateServices.formatDate( f_date, ctrl.parseDateTemp(sbiModule_config.localizedDateFormat));
				var tLocalized = sbiModule_dateServices.formatDate( t_date, ctrl.parseDateTemp(sbiModule_config.localizedDateFormat));
				interval.fromLocalized = fLocalized;
				interval.toLocalized = tLocalized;
