angular.module('measureRuleManager').controller('measureRuleQueryController', [ '$scope','sbiModule_translate' ,'sbiModule_restServices',measureRuleQueryControllerFunction ]);

function measureRuleQueryControllerFunction($scope,sbiModule_translate,sbiModule_restServices){
