			...
			.then(function(response) {
				...
				$scope.i18n.loadI18nMap().then(function() {
					...
					for (var i = 0 ; i < $scope.datasets.length; i ++ ){
						$scope.datasets[i].name = $scope.i18n.getI18n($scope.datasets[i].name);
					}
		...
		$scope.loadMyDatasets = function(){
			...
			.then(function(response) {
				...
				$scope.i18n.loadI18nMap().then(function() {
					...
					for (var i = 0 ; i < $scope.myDatasets.length; i ++ ){
						$scope.myDatasets[i].name = $scope.i18n.getI18n($scope.myDatasets[i].name);
					}
			...
			.then(function(response) {
				...
				$scope.i18n.loadI18nMap().then(function() {
					...
					for (var i = 0 ; i < enterpriseDatasetsWithParams.length; i ++ ){
						enterpriseDatasetsWithParams[i].name = $scope.i18n.getI18n(enterpriseDatasetsWithParams[i].name);
					}
			...
			.then(function(response) {
				...
				$scope.i18n.loadI18nMap().then(function() {
					...
					for (var i = 0 ; i < sharedDatasetsWithParams.length; i ++ ){
						sharedDatasetsWithParams[i].name = $scope.i18n.getI18n(sharedDatasetsWithParams[i].name);
					}
