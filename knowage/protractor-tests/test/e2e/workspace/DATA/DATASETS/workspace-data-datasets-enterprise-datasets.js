describe('workspace - datasets - enterprise datasets', function() {
	...
	it('should click on enterprise datasets tab',function(){
		element.all(by.repeater('tab in $mdTabsCtrl.tabs')).get(1).click();
		browser.sleep(2000);
	});
