describe('workspace - datasets - all datasets', function() {
	...
	it('should click on ckan datasets tab',function(){
		element.all(by.repeater('tab in $mdTabsCtrl.tabs')).get(3).click();
		browser.sleep(2000);
	});
