describe('workspace - smart filters', function() {
	...
	it('should open data share and unshare dataset',function(){
		...
		browser.sleep(2000);
		element.all(by.repeater('suboption in option.submenuOptions')).get(2).click();
	});
