...
Sbi.tools.documents.FileUploadPanel = function(config) {
	...
	Sbi.tools.documents.FileUploadPanel.superclass.constructor.call(this, c);	 		
	
};

Ext.extend(Sbi.tools.documents.FileUploadPanel, Ext.Panel, {
