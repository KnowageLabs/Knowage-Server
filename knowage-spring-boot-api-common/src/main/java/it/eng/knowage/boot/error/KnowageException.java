...
public class KnowageException extends Exception {
	 ...
	 */
	public KnowageException(String message) {
		super(message);
	}
	 ...
	 */
	public KnowageException(String message, Throwable ex) {
		super(message, ex);
	}

	public KnowageException(Throwable ex) {
		super(ex);
	}
