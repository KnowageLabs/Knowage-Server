...
import it.eng.knowage.boot.validation.ObjectValidator;
...
public class JsonConverter {
	...
	public static Object jsonToValidObject(String json, Class<?> t) {
		...
		if (violations == null) {
			...
			throw new KnowageRuntimeException(violations);
		}
	}
	...
	public static Object jsonToObject(String Json, Class<?> t) {
		...
		try {
			...
			throw new KnowageRuntimeException("Error while reading the JSON object", e);
		}
	}
	...
	public static String objectToJson(Object obj, Class<?> t) {
		...
		try {
			...
			throw new KnowageRuntimeException("Error while writing the JSON string", e);
		}
	}
}
