...
public interface ISbiGeoMapsDAO extends ISpagoBIDao {
	/**
	 * Loads all detail information for a map identified by its <code>mapID</code>. All these information, achived by a query to the DB, are stored into an
	 * <code>map</code> object, which is returned.
	 *
	 * @param mapID
	...
	/**
	 * Loads all detail information for maps whose name is equal to <code>name</code>. Each map thatis added into a <code>List</code> object, which is returned.
	 *
	 * @param name
	...
	/**
	 * Implements the query to modify a map. All information needed is stored into the input <code>map</code> object.
	 *
	 * @param aMap
	...
	/**
	 * Implements the query to insert a map. All information needed is stored into the input <code>map</code> object.
	 *
	 * @param aMap
	...
	/**
	 * Implements the query to erase a map. All information needed is stored into the input <code>map</code> object.
	 *
	 * @param aMap
	 ...
	 * @param mapId
	 *            The map identifier
	 * @return True if the map is used by one or more objects, else false
	 * @throws EMFUserError
