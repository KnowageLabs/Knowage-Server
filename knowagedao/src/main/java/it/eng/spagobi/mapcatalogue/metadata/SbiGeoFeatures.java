...
public class SbiGeoFeatures extends SbiHibernateModel {
	 ...
	 */
	public SbiGeoFeatures(int featureId, String name, String descr, String type, Set sbiGeoMapFeatureses) {
		this.featureId = featureId;
		this.name = name;
		this.descr = descr;
		this.type = type;
	...
	/*
	 * public Set getSbiGeoMapFeatureses() { return this.sbiGeoMapFeatureses; }
	 * 
	 * public void setSbiGeoMapFeatureses(Set sbiGeoMapFeatureses) { this.sbiGeoMapFeatureses = sbiGeoMapFeatureses; }
	 */

	/**
	 * From the Hibernate Feature object at input, gives the corrispondent <code>GeoFeature</code> object.
	 *
	...
	public GeoFeature toGeoFeature() {
		...
		/*
		 * List maps = new ArrayList(); Set hibMaps = hibFeature.getSbiGeoMapFeatureses(); for (Iterator it = hibMaps.iterator(); it.hasNext(); ) { SbiGeoMapFeatures
		 * hibMapFeatures = (SbiGeoMapFeatures) it.next(); Integer mapId = hibMapFeatures.getId().getFeatureId(); maps.add(mapId); }
		 * 
