...
public class Content {
	...
	public void setHasFileModel(Boolean hasFileModel) {
		this.hasFileModel = hasFileModel;
	}
	...
	public String toString() {
		return "Content [id=" + id + ", fileName=" + fileName + ", creationDate=" + creationDate + ", active=" + active + ", dimension=" + dimension
