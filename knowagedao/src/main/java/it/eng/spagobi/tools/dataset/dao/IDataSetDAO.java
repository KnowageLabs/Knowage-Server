...
public interface IDataSetDAO extends ISpagoBIDao {
	...
	List<IDataSet> loadDataSetsByOwner(UserProfile user, Boolean includeOwned, Boolean includePublic, Boolean showDerivedDatasets);
	...
	List<IDataSet> loadDataSets(String owner, Boolean includeOwned, Boolean includePublic, String scope, String type, Set<Domain> categoryList,
	...
	List<DataSetBasicInfo> loadDatasetsBasicInfo();
	 ...
	 * @return
	 */
	List<IDataSet> loadFilteredDatasetList(int offset, int fetchSize, String owner, String sortByColumn, boolean reverse, List<Integer> tagIds);
