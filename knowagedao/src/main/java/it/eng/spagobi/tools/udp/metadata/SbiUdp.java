...
public class SbiUdp extends SbiHibernateModel {
	...
	/** full constructor */
	public SbiUdp(Integer udpId, Integer typeId, Integer familyId, String label, String name, String description,
			boolean isMultivalue, Set sbiUdpValues) {
		this.udpId = udpId;
		this.typeId = typeId;
		this.familyId = familyId;
		this.label = label;
	...
	public void changeUdpId(Integer udpId) {
		this.setUdpId(udpId);
