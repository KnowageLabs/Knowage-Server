...
public class DataSetDAOImpl extends AbstractHibernateDAO implements IDataSetDAO {
	...
	public void deleteDataSet(Integer datasetId) {
		...
		try {
			...
			List<BIObject> objectsAssociated = DAOFactory.getBIObjDataSetDAO().getBIObjectsUsingDataset(datasetId, session);
	...
	public boolean hasBIObjAssociated(String dsId) {
		...
		try {
			...
			List<BIObject> objectsAssociated = DAOFactory.getBIObjDataSetDAO().getBIObjectsUsingDataset(dsIdInt, session);
