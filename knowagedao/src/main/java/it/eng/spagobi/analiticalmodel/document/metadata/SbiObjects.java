...
public class SbiObjects extends SbiHibernateModel {
	 ...
	 * Gets the data set.
	 *
	 * @return the data set public SbiDataSet getDataSet() { return dataSet; }
	 */

	/**
	 * Sets the data set.
	 *
	 * @param dataSet the new data set public void setDataSet(SbiDataSet dataSet) { this.dataSet = dataSet; }
	 */
