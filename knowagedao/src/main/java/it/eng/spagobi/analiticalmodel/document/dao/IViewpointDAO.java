...
public interface IViewpointDAO extends ISpagoBIDao {
	...
	/**
	 * Loads all detail information for all viewpoints. For each of them, detail information is stored into a <code>ViewPoint</code> object. After that, all
	...
	/**
	 * Loads all detail information for all viewpoints of a object specified. For each of them, detail information is stored into a <code>ViewPoint</code>
	...
	/**
	 * Loads all detail information for a viewpoint identified by its <code>name</code> and relevant document identifier. All these information are stored into
	 * a <code>Viewpoint</code> object, which is returned.
	 *
	 * @param name
	...
	/**
	 * Implements the query to modify a viewpoint. All information needed is stored into the input <code>Viewpoint</code> object.
	 *
	 * @param objId
	 *            the obj id
	 * @param userProfile
