...
public interface ISnapshotDAO extends ISpagoBIDao {
	 ...
	 * @param contentType
	 * @param schedulationStart time when schedulation is started
	 * @param schedulationName  name of the schedulation
	 * @throws EMFUserError the EMF user error
	 */
	void saveSnapshot(byte[] content, Integer idBIObj, String name, String description, String contentType, long schedulationStart, String schedulerName,
	 ...
	 * @throws EMFUserError the EMF user error
	 */
	List<Snapshot> getSnapshots(Integer idBIObj) throws EMFUserError;
	 ...
	 * @throws EMFUserError the EMF user error
	 */
	List<SnapshotMainInfo> getSnapshotMainInfos(Integer idBIObj) throws EMFUserError;
	 ...
	 * @throws EMFUserError the EMF user error
	 */
	void deleteSnapshot(Integer idSnap) throws EMFUserError;
	 ...
	 * @throws EMFUserError the EMF user error
	 */
	Snapshot loadSnapshot(Integer idSnap) throws EMFUserError;
	 ...
	 * @throws EMFUserError the EMF user error
	 */
	Snapshot getLastSnapshot(Integer idBIObj) throws EMFUserError;

	/**
	 * Get all snapshot linked to a skedulation
	 *
	 * @param Schedulation name
	 *
	 * @return returns all the snapshot groupped by schedulations and execution time
	 *
	 * @throws EMFUserError the EMF user error
	 */
	Map<String, Map<Integer, List<Snapshot>>> getSnapshotsBySchedulation(String schedulationName, boolean collate, boolean loadContent) throws EMFUserError;
	 ...
	 * @throws EMFUserError
	 */
	List<Snapshot> getLastSnapshotsBySchedulation(String schedulationName, boolean collate) throws EMFUserError;
	 ...
	 * @throws EMFUserError the EMF user error
	 */
	List<Snapshot> getSnapshotsForSchedulationAndDocument(Integer idBIObj, String scheduler, boolean loadContent) throws EMFUserError;

	String loadSnapshotSchedulation(Integer idSnap) throws EMFUserError;
}
