...
public class SbiObjectsRatingId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SbiObjectsRatingId))
			return false;
		SbiObjectsRatingId castOther = (SbiObjectsRatingId) other;

		return ((this.getObjId() == castOther.getObjId()) || (this.getObjId() != null && castOther.getObjId() != null
				&& this.getObjId().equals(castOther.getObjId())))
