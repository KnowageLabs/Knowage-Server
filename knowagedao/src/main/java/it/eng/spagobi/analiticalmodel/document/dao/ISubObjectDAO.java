...
public interface ISubObjectDAO extends ISpagoBIDao {
	 ...
	 */
	Integer saveSubObject(Integer idBIObj, SubObject subObj) throws EMFUserError;
	 ...
	 * @throws EMFUserError the EMF user error
	 */
	Integer modifySubObject(Integer idBIObj, SubObject subObj) throws EMFUserError;
	 ...
	 * @throws EMFUserError the EMF user error
	 */
	List<SubObject> getAccessibleSubObjects(Integer idBIObj, IEngUserProfile profile) throws EMFUserError;
	 ...
	 * @throws EMFUserError the EMF user error
	 */
	SubObject getSubObject(Integer idSubObj) throws EMFUserError;
	 ...
	 * @throws EMFUserError the EMF user error
	 */
	void deleteSubObject(Integer idSub) throws EMFUserError;
	 ...
	 * @throws EMFUserError the EMF user error
	 */
	void deleteSubObjectSameConnection(Integer idSub, Session aSession) throws EMFUserError;
	 ...
	 * @throws EMFUserError the EMF user error
	 */
	List<SubObject> getSubObjects(Integer idBIObj) throws EMFUserError;
	 ...
	 * @throws EMFUserError the EMF user error
	 */
	List<SubObject> getPublicSubObjects(Integer idBIObj) throws EMFUserError;
	 ...
	 * @throws EMFUserError the EMF user error
	 */
	SubObject getSubObjectByNameAndBIObjectId(String name, Integer idBIObj) throws EMFUserError;
}
