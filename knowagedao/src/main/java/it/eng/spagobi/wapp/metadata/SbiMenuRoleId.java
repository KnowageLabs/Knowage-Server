...
public class SbiMenuRoleId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SbiMenuRoleId))
			return false;
		...
		return ((this.getMenuId() == castOther.getMenuId()) || (this.getMenuId() != null
				...
				&& ((this.getExtRoleId() == castOther.getExtRoleId()) || (this.getExtRoleId() != null
						&& castOther.getExtRoleId() != null && this.getExtRoleId().equals(castOther.getExtRoleId())));
	}
