...
public class MenuRolesDAOImpl extends AbstractHibernateDAO implements IMenuRolesDAO {
	...
	public List loadMenuByRoleId(Integer roleId) throws EMFUserError {
		...
		try {
			...
			hql = " select mf.id.menuId from SbiMenuRole as mf, SbiMenu m " + " where mf.id.menuId = m.menuId " + " and mf.id.extRoleId = ? "
...
//			Iterator it = hibList.iterator();
			...
			realResult = menuDAO.loadMenuByIDInClause(hibList, roleId);
//			Menu tmpMenu = null;
//			while (it.hasNext()) {
