...
public interface IAuditDAO extends ISpagoBIDao {
	...
	/**
	 * Loads all detail information for an audit record identified by its <code>id</code>. All these information, achived by a query to the DB, are stored into
	 * an <code>SbiAudit</code> object, which is returned.
	 *
	 ...
	 * @throws EMFUserError If an Exception occurred
	 */
	public void eraseAuditPeriodic(Integer id) throws EMFUserError;
