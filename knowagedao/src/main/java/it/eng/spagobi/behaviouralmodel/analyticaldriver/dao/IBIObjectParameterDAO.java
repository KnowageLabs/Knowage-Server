...
public interface IBIObjectParameterDAO extends ISpagoBIDao {
	...
	SbiObjPar loadById(Integer id) throws EMFUserError;
	 ...
	 * @throws EMFUserError
	 */
	BIObjectParameter loadBiObjParameterByObjIdAndLabel(Integer objId, String label) throws EMFUserError;
	...
	BIObjectParameter loadForDetailByObjParId(Integer objParId) throws EMFUserError;
	 ...
	 * @throws EMFUserError If an Exception occurred
	 */
	void modifyBIObjectParameter(BIObjectParameter aBIObjectParameter) throws HibernateException;
	 ...
	 * @throws EMFUserError If an Exception occurred
	 */
	Integer insertBIObjectParameter(BIObjectParameter aBIObjectParameter) throws HibernateException;
	 ...
	 * @throws EMFUserError If an Exception occurred
	 */
	void eraseBIObjectParameter(BIObjectParameter aBIObjectParameter, boolean alsoDependencies) throws HibernateException;
	 ...
	 * @throws EMFUserError If an Exception occurred
	 */
	List<String> getDocumentLabelsListUsingParameter(Integer parId) throws EMFUserError;
	 ...
	 */
	List<BIObjectParameter> loadBIObjectParametersById(Integer biObjectID) throws HibernateException;
	...
	void eraseBIObjectParameterDependencies(BIObjectParameter aBIObjectParameter, Session aSession) throws EMFUserError;
	 ...
	 * @param aSession
	 */
	void eraseBIObjectParametersByObjectId(Integer biObjId, Session currSession) throws EMFUserError;
