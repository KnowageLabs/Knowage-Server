...
public interface IObjParuseDAO extends ISpagoBIDao {
	...
	/**
	 * Loads the list of ObjParuse associated to the input <code>objParId</code> and <code>paruseId</code>. All these information, achived by a query to the DB,
	 * are stored into a List of <code>ObjParuse</code> object, which is returned.
	 *
