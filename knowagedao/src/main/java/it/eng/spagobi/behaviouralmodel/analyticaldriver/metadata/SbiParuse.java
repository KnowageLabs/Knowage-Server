...
public class SbiParuse extends SbiHibernateModel {
	...
	private Set<SbiParuseDet> sbiParuseDets;
	private Set<SbiParuseCk> sbiParuseCks;
	...
	public SbiLov getSbiLovForMax() {
		return this.sbiLovForMax;
	}

	public void setSbiLovForMax(SbiLov sbiLovForMax) {
		this.sbiLovForMax = sbiLovForMax;
	}
	 ...
	 */
	public Set<SbiParuseDet> getSbiParuseDets() {
	 ...
	 */
	public void setSbiParuseDets(Set<SbiParuseDet> sbiParuseDets) {
	 ...
	 */
	public Set<SbiParuseCk> getSbiParuseCks() {
	 ...
	 */
	public void setSbiParuseCks(Set<SbiParuseCk> sbiParuseCks) {
