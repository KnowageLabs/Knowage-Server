...
public interface IModalitiesValueDAO extends ISpagoBIDao {
	...
	/**
	 * Loads all detail information for an value identified by its <code>modalitiesValueID</code>. All these information, achived by a query to the DB, are
	 * stored into a <code>ModalitiesValue</code> object, which is returned.
	 *
	...
	/**
	 * Loads all detail information for a lov by its <code>label</code>. All these information, achived by a query to the DB, are stored into a
	 * <code>ModalitiesValue</code> object, which is returned.
	 *
	 * @param label
	...
	/**
	 * Loads all detail information for all values . All these information, achived by a query to the DB, are stored into a list of <code>ModalitiesValue</code>
	 * objects, which is returned.
	 *
	...
	/**
	 * Implements the query to modify a value. All information needed is stored into the input <code>ModalitiesValue</code> object.
	 *
	...
	/**
	 * Implements the query to insert a value. All information needed is stored into the input <code>ModalitiesValue</code> object.
	 *
	 * @param aModalitiesValue
	 *            The object containing all insert information
	 *
	 * @return Id of new ModalitiesValue
	 *
	 * @throws EMFUserError
	 *             If an Exception occurred
	 */
	...
	/**
	 * Implements the query to erase a value. All information needed is stored into the input <code>ModalitiesValue</code> object.
	 *
	 * @param aModalitiesValue
	...
	/**
	 * Controls if a value in the predefined LOV is associated or not with a parameter. It is useful because a Value can be deleted only if it hasn't any
	 * parameter associated.
	 *
	 * @param idLov
	 *            The value id
	 *
	 * @return True if the value has one or more parameters associated; false if it hasn't any
	 *
	 * @throws EMFUserError
	 *             If an Exception occurred
	 */
