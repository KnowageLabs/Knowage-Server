...
/**
 * TODO This is not the right place for this class but its strong dependency with {@link DAOFactory} is a problem.
 */
public class EngineUtilities {
	...
	private static Domain getEngTypeDom(Engine engine) {
		...
		try {
			...
			SpagoBITracer.major(SpagoBIConstants.NAME_MODULE, EngineUtilities.class.getName(), "getEngTypeDom",
					"Error retrieving engine type domain", e);
		}
		return engineType;
	}
	...
	public static boolean hasBackEndService(Engine engine) {
