...
DELETE FROM SBI_FUNCTION_INPUT_COLUMN 	WHERE ORGANIZATION = ?
DELETE FROM SBI_FUNCTION_OUTPUT_COLUMN 	WHERE ORGANIZATION = ?
DELETE FROM SBI_OBJ_FUNCTION		 	WHERE ORGANIZATION = ?
...
DELETE FROM SBI_DASHBOARD_THEME WHERE ORGANIZATION = ?
