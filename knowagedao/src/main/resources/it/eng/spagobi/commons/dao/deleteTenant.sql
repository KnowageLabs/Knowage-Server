...
DELETE FROM SBI_FUNCTION_INPUT_DATASET 	WHERE FUNCTION_ID IN (SELECT c.FUNCTION_ID FROM SBI_CATALOG_FUNCTION c WHERE c.ORGANIZATION = ?)
DELETE FROM SBI_FUNCTION_INPUT_FILE 	WHERE FUNCTION_ID IN (SELECT c.FUNCTION_ID FROM SBI_CATALOG_FUNCTION c WHERE c.ORGANIZATION = ?)
DELETE FROM SBI_FUNCTION_OUTPUT 		WHERE FUNCTION_ID IN (SELECT c.FUNCTION_ID FROM SBI_CATALOG_FUNCTION c WHERE c.ORGANIZATION = ?)
