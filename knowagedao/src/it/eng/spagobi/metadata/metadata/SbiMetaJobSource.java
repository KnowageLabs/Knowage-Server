...
public class SbiMetaJobSource extends SbiHibernateModel {
	...
	public SbiMetaJobSource(SbiMetaJobSourceId id, SbiMetaSource sbiMetaSource, SbiMetaJob sbiMetaJob, String userIn, Date timeIn) {
		this.id = id;
	...
	public SbiMetaJobSource(SbiMetaJobSourceId id, SbiMetaSource sbiMetaSource, SbiMetaJob sbiMetaJob, String userIn, String userUp, String userDe,
			Date timeIn, Date timeUp, Date timeDe, String sbiVersionIn, String sbiVersionUp, String sbiVersionDe, String metaVersion, String organization) {
		this.id = id;
		this.sbiMetaSource = sbiMetaSource;
		this.sbiMetaJob = sbiMetaJob;
		this.userIn = userIn;
