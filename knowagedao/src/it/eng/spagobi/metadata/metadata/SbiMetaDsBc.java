...
public class SbiMetaDsBc extends SbiHibernateModel {
	...
	public SbiMetaDsBc(SbiMetaDsBcId id, SbiMetaBc sbiMetaBc, String userIn, Date timeIn) {
		this.id = id;
	...
	public SbiMetaDsBc(SbiMetaDsBcId id, SbiMetaBc sbiMetaBc, String userIn, String userUp, String userDe, Date timeIn, Date timeUp, Date timeDe,
