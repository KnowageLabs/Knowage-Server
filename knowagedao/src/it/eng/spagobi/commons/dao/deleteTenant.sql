DELETE FROM SBI_ACTIVITY_MONITORING WHERE ORGANIZATION = ?;
...
DELETE FROM SBI_PROGRESS_THREAD WHERE ORGANIZATION = ?;
...
DELETE FROM SBI_ROLE_TYPE_USER_FUNC WHERE ORGANIZATION = ?;
DELETE FROM SBI_AUTHORIZATIONS WHERE ORGANIZATION = ?;
DELETE FROM SBI_CHECKS WHERE ORGANIZATION = ?;
DELETE FROM SBI_DATA_SET_FEDERATION WHERE ORGANIZATION = ?;
...
DELETE FROM SBI_EXPORTERS WHERE ORGANIZATION = ?;
...
DELETE FROM SBI_CONFIG WHERE ORGANIZATION = ?;
DELETE FROM SBI_DATA_SET WHERE ORGANIZATION = ?;
DELETE FROM SBI_DATA_SOURCE WHERE ORGANIZATION = ?;
DELETE FROM SBI_DIST_LIST WHERE ORGANIZATION = ?;
DELETE FROM SBI_ENGINES WHERE ORGANIZATION = ?;
...
DELETE FROM SBI_GL_BNESS_CLS WHERE ORGANIZATION = ?;
DELETE FROM SBI_GL_CONTENTS WHERE ORGANIZATION = ?;
DELETE FROM SBI_GL_TABLE WHERE ORGANIZATION = ?;
...
DELETE FROM SBI_PRODUCT_TYPE WHERE ORGANIZATION = ?;
...
DELETE FROM SBI_DOMAINS WHERE ORGANIZATION = ?;
