...
DELETE FROM SBI_GL_CONTENTS WHERE PARENT_ID IS NOT NULL AND ORGANIZATION = ?
...
DELETE FROM SBI_FUNCTION_INPUT_VARIABLE WHERE ORGANIZATION = ?
DELETE FROM SBI_FUNCTION_INPUT_DATASET WHERE ORGANIZATION = ?
DELETE FROM SBI_FUNCTION_OUTPUT WHERE ORGANIZATION = ?
