...
ALTER TABLE SBI_DATA_SET_FEDERATION ADD CONSTRAINT FK_SBI_DATA_SET_FEDERATION_FEDERATION FOREIGN KEY (FEDERATION_ID) REFERENCES SBI_FEDERATION_DEFINITION (FEDERATION_ID);
ALTER TABLE SBI_DATA_SET_FEDERATION ADD CONSTRAINT FK_SBI_DATA_SET_FEDERATION_DATA_SET FOREIGN KEY (DS_ID, VERSION_NUM, ORGANIZATION) REFERENCES SBI_DATA_SET (DS_ID, VERSION_NUM,ORGANIZATION);