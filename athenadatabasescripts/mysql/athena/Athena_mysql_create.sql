...
ALTER TABLE `SBI_GEO_LAYERS` CHANGE COLUMN `META_VERSION` `META_VERSION` VARCHAR(100) NULL DEFAULT NULL COMMENT '' AFTER `IS_BASE_LAYER`,
ADD COLUMN `PATHFILE` VARCHAR(500) NULL COMMENT '' AFTER `META_VERSION`,
ADD COLUMN `LAYER_LABEL` VARCHAR(255) NOT NULL COMMENT '' AFTER `PATHFILE`,
ADD COLUMN `LAYER_NAME` VARCHAR(255) NOT NULL COMMENT '' AFTER `LAYER_LABEL`,
ADD COLUMN `LAYER_IDENTIFY` VARCHAR(255) NULL COMMENT '' AFTER `LAYER_NAME`,
ADD COLUMN `LAYER_URL` VARCHAR(1024) NULL COMMENT '' AFTER `LAYER_IDENTIFY`,
ADD COLUMN `LAYER_OPTIONS` VARCHAR(1024) NULL COMMENT '' AFTER `LAYER_URL`,
ADD COLUMN `LAYER_PARAMS` VARCHAR(1024) NULL COMMENT '' AFTER `LAYER_OPTIONS`,
ADD COLUMN `LAYER_ORDER` INT(11) NOT NULL DEFAULT 0 COMMENT '' AFTER `LAYER_PARAMS`,
ADD COLUMN `GEO_CATEGORY` INT(11) NULL COMMENT '' AFTER `LAYER_ORDER`;
