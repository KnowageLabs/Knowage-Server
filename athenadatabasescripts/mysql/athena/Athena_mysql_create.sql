...
--create table for layer catalog
CREATE TABLE `sbi_geo_layers` (
  `LAYER_ID` int(11) NOT NULL,
  `LABEL` varchar(100) NOT NULL,
  `NAME` varchar(100) DEFAULT NULL,
  `DESCR` varchar(200) DEFAULT NULL,
  `LAYER_DEFINITION` blob,
  ...
  `LAYER_LABEL` varchar(200) NOT NULL,
  `LAYER_NAME` varchar(200) NOT NULL,
  `LAYER_IDENTIFY` varchar(200) DEFAULT NULL,
  `LAYER_URL` varchar(200) DEFAULT NULL,
  `LAYER_OPTIONS` varchar(200) DEFAULT NULL,
  `LAYER_PARAMS` varchar(200) DEFAULT NULL,
