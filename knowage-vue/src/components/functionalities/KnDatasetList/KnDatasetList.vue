<template>
    <Dialog class="kn-dialog--toolbar--primary datasetListDialogClass" v-bind:visible="visibility" :header="$t('workspace.advancedData.chooseDataset')" :closable="false" modal :breakpoints="{ '960px': '75vw', '640px': '100vw' }">
        <DataTable
...
export default defineComponent({
    ...
    computed: {
        ...mapGetters(['isAvroLoaded', 'isAvroLoading'])
    },
    methods: {
        apply(): void {
