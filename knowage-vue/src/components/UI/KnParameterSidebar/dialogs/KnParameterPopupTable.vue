  ...
  >
    <template #empty>
      <Message
        ...
        severity="info"
        :closable="false"
        :style="knParameterPopupDialogDescriptor.styles.message"
      >
    ...
    <Column
      ...
      :style="knParameterPopupDialogDescriptor.styles.checkboxColumn"
    ></Column>
    <Column
      class="kn-truncated"
...
export default defineComponent({
  ...
  methods: {
    loadData() {
      ...
      this.columns = [];
      Object.keys(this.parameterPopUpData?.result.metadata.colsMap).forEach(
        (key: string) => {
          this.columns.push({
