    ...
    computed: {
        ...
        documentImageSource(): any {
            if (this.document[this.documentFields.image]) {
                return {
                    'background-image': `url(${import.meta.env.VITE_HOST_URL}${descriptor.imgPath}${this.document[this.documentFields.image]}),url(../images/workspace/documentTypes/${cardDescriptor.defaultImages.missing})`
                }
            }
            return {
                'background-image': `url(../images/workspace/documentTypes/${cardDescriptor.defaultImages[this.document.type] || cardDescriptor.defaultImages.missing})`
            }
        },
        documentFields(): any {
