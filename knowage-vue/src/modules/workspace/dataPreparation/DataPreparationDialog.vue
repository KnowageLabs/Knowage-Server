<template>
    ...
    >
        ...
        <DataPreparationSimple v-bind:transformation="localCopy" v-bind:visible="localCopy.type === 'simple' ? localCopy : {}" :columns="columns" :col="col" />
        <DataPreparationCustom v-bind:transformation="localCopy" v-bind:visible="localCopy.type === 'custom' ? localCopy : {}" :columns="columns" :col="col" />
