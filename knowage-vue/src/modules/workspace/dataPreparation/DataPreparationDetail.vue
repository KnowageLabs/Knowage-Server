<template>
    <div class="kn-page kn-data-preparation">
        ...
        <DataPreparationSaveDialog v-model:visibility="showSaveDialog" :originalDataset="dataset" :columns="columns" :instanceId="instanceId" @update:instanceId="updateInstanceId" :processId="processId" @update:processId="updateprocessId" :preparedDsMeta="preparedDsMeta" @config="dataset.config" />
