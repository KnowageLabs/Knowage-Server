<template>
    ...
    <WorkspaceSchedulationOldSchedulationsDialog :visible="schedulationsDialogVisible" :selectedJob="selectedJob as any" @close="closeOldSchedulationsDialog"></WorkspaceSchedulationOldSchedulationsDialog>
</template>
