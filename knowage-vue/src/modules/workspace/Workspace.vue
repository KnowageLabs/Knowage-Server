    ...
    export default defineComponent({
        ...
        methods: {
            ...
            createMenuItems() {
                ...
                if ((this.$store.state as any).user.functionalities.includes('DataPreparation')) this.menuItems.push({ icon: 'fas fa-cogs', key: '6', label: 'workspace.menuLabels.advanced', value: 'advanced' })
            },
