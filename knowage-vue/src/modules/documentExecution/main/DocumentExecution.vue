...
export default defineComponent({
    ...
    computed: {
        canEditCockpit(): boolean {
            ...
            return (this.document.engine === 'knowagecockpitengine' || this.document.engine === 'knowagedashboardengine') && (this.user.functionalities?.includes('DocumentAdminManagement') || this.document.creationUser === this.user.userId)
        },
