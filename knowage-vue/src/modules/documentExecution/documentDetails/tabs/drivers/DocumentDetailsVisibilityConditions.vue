        ...
        <form class="p-fluid p-formgrid p-grid p-m-2">
            ...
            <div class="p-field p-col-12 p-md-4">
                <span class="p-float-label">
                    ...
                    />
                    <label for="operator" class="kn-material-input-label"> {{ $t('managers.businessModelManager.filterOperator') }} *</label>
                </span>
                <KnValidationMessages class="p-mt-1" :vComp="v$.selectedCondition.operation" :additionalTranslateParams="{ fieldName: $t('managers.businessModelManager.filterOperator') }" />
            </div>
            <div class="p-field p-col-12 p-md-4">
                <span class="p-float-label">
