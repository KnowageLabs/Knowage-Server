    ...
    <div v-if="driver && driver.parameterValue" class="p-fluid p-formgrid p-grid p-jc-center p-ai-center p-p-5 p-m-0">
        ...
        <div class="p-field p-col-12">
            <span class="p-float-label">
                <Dropdown v-if="!driver.multivalue" class="kn-material-input" v-model="driver.parameterValue[0].value" :options="driver.options" optionValue="value" optionLabel="description" @change="onDropdownChange" />
...
export default defineComponent({
    ...
    components: { Checkbox, Dropdown, RadioButton },
    ...
    methods: {
        ...
        onDropdownChange() {
            ...
            console.log('>>>>> DROPDOWN CHANGED: ', this.driver)
