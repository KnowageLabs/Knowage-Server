<template>
    ...
    <div class="p-d-flex kn-flex kn-overflow" v-if="propWidget">
        ...
        <TableWidgetDataContainer v-else-if="propWidget.type === 'table' || propWidget.type === 'html' || propWidget.type === 'text'" class="kn-flex model-div kn-overflow p-mx-2 p-my-3" :widgetModel="propWidget" :selectedDataset="selectedDataset"></TableWidgetDataContainer>
