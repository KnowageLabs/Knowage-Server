        ...
        <div class="toolbar-context-menu-option" v-for="(option, index) in options" :key="index">
            <div class="toolbar-context-item kn-cursor-pointer" @click="setSelectedValue(option.value)">
                <div class="toolbar-item-text">
                    {{ settings.translateLabels ? $t(option.label) : option.label }}
                </div>
...
export default defineComponent({
    name: 'widget-editor-toolbar-dropdown',
    components: {},
    props: { settings: { type: Object, required: true }, options: { type: Array as PropType<any[]>, required: true } },
