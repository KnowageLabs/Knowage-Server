<template>
    <div>
        <Button v-for="(button, index) in filteredButtons" :key="index" :icon="button.icon" class="p-button-text p-button-rounded p-button-plain" @click="clickedButton(button)" v-tooltip.bottom="$t(button.label)" />
    </div>
</template>
