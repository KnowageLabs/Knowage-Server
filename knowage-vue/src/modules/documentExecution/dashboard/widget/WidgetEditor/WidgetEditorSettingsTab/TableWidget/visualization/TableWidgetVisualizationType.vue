<template>
    <div v-if="visualizationTypeModel" class="p-grid p-ai-center p-p-4">
        ...
        <div v-for="(visualizationType, index) in visualizationTypeModel.types" :key="index" class="p-grid p-col-12 p-ai-center p-ai-center p-pt-2">
