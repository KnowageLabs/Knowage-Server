<template>
    <div v-if="crossNavigationModel" class="p-grid p-jc-center p-ai-center p-p-4">
        <div class="p-grid p-col-12 p-ai-center">
            <div v-if="widgetModel.type !== 'chart' && widgetModel.type !== 'image'" class="p-col-6 p-sm-12 p-md-6 p-d-flex p-flex-column kn-flex p-px-2">
        ...
        <div class="p-grid p-col-12 p-ai-center">
            <div v-if="widgetModel.type !== 'image'" class="p-sm-12 p-md-5 p-d-flex p-flex-row p-ai-center p-px-2">
