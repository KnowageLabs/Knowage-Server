<template>
    <div v-if="customMessagesModel" class="p-grid p-ai-center">
        <div class="p-sm-12 p-md-3 p-pt-4">
            <Checkbox v-model="customMessagesModel.hideNoRowsMessage" :binary="true" @change="customMessagesChanged" />
            <label class="kn-material-input-label p-ml-2"> {{ $t('dashboard.widgetEditor.customMessages.hideNoRowsAvailable') }}</label>
        </div>
        <div class="p-sm-12 p-md-9 p-d-flex p-flex-column p-pt-2">
