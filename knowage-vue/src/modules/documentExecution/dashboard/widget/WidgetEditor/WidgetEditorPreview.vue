...
export default defineComponent({
  ...
  methods: {
    ...
    setEventListeners() {
      ...
      emitter.on("collumnUpdated", (payload) => this.onColumnUpdate(payload));
      emitter.on("columnsReordered", (columns) =>
        console.log("WidgetEditorPreview  - columnsReordered!")
      );
      emitter.on("indexColumnChanged", () =>
        console.log("WidgetEditorPreview  - indexColumnChanged!")
      );
      emitter.on("rowSpanChanged", () =>
        console.log("WidgetEditorPreview  - rowSpanChanged!")
      );
    ...
    onColumnUpdate(payload: { column: IWidgetColumn; columnIndex: number }) {
      // console.log('WidgetEditorPreview  - collumnAdded!', this.propWidget)
      console.log("WidgetEditorPreview  - columnEdited!", payload.column);
      console.log(
        "WidgetEditorPreview  - columnEdited index!",
        payload.columnIndex
      );
      console.log(
        "GET TABULATOR COLUMNS ",
        payload.column.columnName,
        this.tabulator.updateColumnDefinition("FID", {
          title: payload.column.alias,
        })
      );
