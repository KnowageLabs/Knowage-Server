        ...
        <div class="widget-container p-mx-2" :style="getWidgetContainerStyle()">
            ...
            <div class="widget-container-renderer" :style="getWidgetPadding()">
                ...
                <WebComponentContainer
                    ...
                    :variables="variables"
                ></WebComponentContainer>
                <HighchartsContainer v-if="propWidget.type === 'highcharts' && !loading && user.enterprise" :widget-model="propWidget" :data-to-show="widgetData" :prop-active-selections="activeSelections" :editor-mode="true" :dashboard-id="dashboardId"></HighchartsContainer>
