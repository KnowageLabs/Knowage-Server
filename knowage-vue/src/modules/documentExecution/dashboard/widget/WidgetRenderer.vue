<template>
    <div class="widget-container" :style="getWidgetContainerStyle()">
        ...
        <div class="widget-container-renderer" :style="getWidgetPadding()">
            <TableWidget v-if="widget.type == 'table'" :propWidget="widget" :datasets="datasets" :dataToShow="dataToShow" :editorMode="false" :propActiveSelections="activeSelections" :dashboardId="dashboardId" @pageChanged="$emit('pageChanged')" @launchSelection="$emit('launchSelection', $event)" />
