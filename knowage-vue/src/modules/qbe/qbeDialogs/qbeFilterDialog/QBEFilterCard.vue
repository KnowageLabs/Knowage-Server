    ...
    <div class="p-grid p-m-2">
      ...
      <div class="p-col-2 p-d-flex p-flex-row p-ai-center" v-if="filter.operator !== 'IS NULL' && filter.operator !== 'NOT NULL'">
        <div class="kn-flex">
          ...
          <Dropdown class="kn-material-input" v-model="filter.rightType" :options="['STARTS WITH', 'NOT STARTS WITH', 'ENDS WITH', 'NOT ENDS WITH', 'CONTAINS', 'NOT CONTAINS', 'BETWEEN', 'NOT BETWEEN'].includes(filter.operator) ? [targetValues[0]] : targetValues" optionValue="value" optionLabel="label" @change="onFilterTypeChange" />
        </div>
      </div>
      ...
      <div class="p-col-4 p-d-flex p-flex-row p-ai-center" v-if="filter.operator !== 'IS NULL' && filter.operator !== 'NOT NULL'">
        <div class="kn-flex">
          ...
          <div class="p-d-flex p-flex-row p-ai-center">
            ...
            <q-input class="col" dense v-if="filter.rightType === 'anotherEntity'" readonly v-model="filter.rightOperandDescription" @update:model-value="onEntityTypeChanged" :label="$t('qbe.filters.target')">
