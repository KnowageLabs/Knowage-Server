...
export default defineComponent({
    name: 'qbe',
    components: { Dialog, Chip, InputSwitch, ScrollPanel, Menu, QBESmartTable, QBEFilterDialog, QBESavingDialog, QBESqlDialog, QBESimpleTable, QBERelationDialog, QBEParamDialog, ExpandableEntity, SubqueryEntity, QBEHavingDialog, QBEAdvancedFilterDialog, QBEJoinDefinitionDialog, KnParameterSidebar },
