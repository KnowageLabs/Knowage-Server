    ...
    <div v-if="perspective">
        <div class="p-d-flex p-flex-row p-ai-center p-m-2">
            <div class="kn-flex">
                ...
                <i class="fa-solid fa-rectangle-list p-mr-2" />
                <span>
                    {{ perspective.name }}
                </span>
            </div>
...
export default defineComponent({
    ...
    components: { SelectButton, ScorecardsTargetItem, ScorecardsTableHint },
    ...
    methods: {
        ...
        deleteTarget(target: iScorecardTarget) {
            ...
            if (index !== -1) this.perspective.targets.splice(index, 1)
        }
    }
})
</script>
