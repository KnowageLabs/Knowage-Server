...
export default defineComponent({
    ...
    components: { Card, Calendar, Dropdown, HierarchyManagementHierarchyMasterDialog },
    ...
    methods: {
        async onSelectedDimensionChange() {
            console.log('>>> >>> ON SELECTED DIMENSION CHANGED: ', this.selectedDimension)
        ...
        async loadDimensionMetadata() {
            ...
            console.log('LOADED DIMENSION METADATA: ', this.dimensionMetadata)
        },
        async loadNodeMetadata() {
            ...
            this.$emit('loading', false)
            console.log('LOADED NODE METADATA: ', this.nodeMetadata)
        },
