...
export default defineComponent({
    ...
    methods: {
        ...
        async loadBackupData() {
            ...
            await this.$http.get(import.meta.env.VUE_APP_RESTFUL_SERVICES_PATH + url).then((response: AxiosResponse<any>) => {
        ...
        async deleteBackup(hierarchy) {
            ...
            await this.$http.post(import.meta.env.VUE_APP_RESTFUL_SERVICES_PATH + url, postData).then((response: AxiosResponse<any>) => {
