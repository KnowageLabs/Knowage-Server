<template>
	<div class="managerDetail">
		...
		<div class="p-grid p-m-0 flex" v-if="template.type && windowWidth >= windowWidthBreakPoint">
			<div :class="galleryDescriptor.allowedEditors[template.type].length === 2 ? 'p-col-6' : 'p-col-4'" v-for="allowedEditor in galleryDescriptor.allowedEditors[template.type]" v-bind:key="allowedEditor" style="height:100%;display:flex;flex-direction:column">
				<h4>
