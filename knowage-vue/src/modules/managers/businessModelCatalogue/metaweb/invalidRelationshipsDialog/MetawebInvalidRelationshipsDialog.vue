<template>
    <Dialog id="metaweb-inccorect-relationships-dialog" class="p-fluid kn-dialog--toolbar--primary" :style="metawebInvalidRelationshipsDialogDescriptor.dialog.style" :visible="visible" :modal="true" :closable="false" :baseZIndex="10" :autoZIndex="false">
        <template #header>
