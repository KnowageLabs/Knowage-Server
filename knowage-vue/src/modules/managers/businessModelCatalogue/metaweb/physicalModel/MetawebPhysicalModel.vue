...
export default defineComponent({
    ...
    methods: {
        ...
        async openUpdateDialog() {
            ...
            await this.$http.get(import.meta.env.VUE_APP_META_API_URL + '/1.0/metaWeb/updatePhysicalModel').then((response: AxiosResponse<any>) => (this.changedItem = response.data))
