                    ...
                    >
                        ...
                        <template #option="slotProps">
                            <div class="kn-list-item" data-test="list-item">
                                ...
                                <Button icon="far fa-trash-alt" class="p-button-link p-button-sm" @click.stop="deleteDatasourceConfirm(slotProps.option.dsId)" data-test="delete-button" />
                            </div>
                        </template>
                    </Listbox>
                </div>
...
export default defineComponent({
    ...
    methods: {
        ...
        showForm(event: any) {
            const path = event.value ? `/datasource/${event.value.id}` : '/datasource/new-datasource'
