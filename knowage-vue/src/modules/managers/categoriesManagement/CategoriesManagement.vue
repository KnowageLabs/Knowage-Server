...
export default defineComponent({
    ...
    methods: {
        async loadCategories() {
            this.loading = true
            await this.$http
                .get(process.env.VUE_APP_RESTFUL_SERVICES_PATH + '3.0/category/categories')
        ...
        async deleteCategory(category: iCategory) {
            ...
            await this.$http.delete(process.env.VUE_APP_RESTFUL_SERVICES_PATH + '3.0/category', { data: dataToDelete }).then(() => {
