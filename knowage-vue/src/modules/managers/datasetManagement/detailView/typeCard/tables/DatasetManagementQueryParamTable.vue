<template>
    ...
    <Card v-show="expandTableCard" class="p-mx-2">
        <template #content>
            <DataTable class="p-datatable-sm kn-table" edit-mode="cell" :value="dataset.restRequestAdditionalParameters" :scrollable="true" scroll-height="250px" data-key="versNum" responsive-layout="stack" breakpoint="960px" @cell-edit-complete="onCellEditComplete">
                <template #empty>
