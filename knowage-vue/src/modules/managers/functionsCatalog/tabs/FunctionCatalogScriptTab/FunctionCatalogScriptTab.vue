<template>
    <div class="p-field kn-flex p-m-2">
        <span>
            ...
            <Dropdown class="kn-material-input" v-model="selectedFunction.language" :options="functionCatalogScriptTabDescriptor.languages" optionLabel="value" optionValue="value" :disabled="readonly" />
        </span>
    </div>
...
import functionCatalogScriptTabDescriptor from './FunctionCatalogScriptTabDescriptor.json'
...
export default defineComponent({
    ...
    data() {
        return {
            functionCatalogScriptTabDescriptor,
