<template>
    <Card>
        ...
        <template #content>
            ...
            <template v-else>
                <FunctionCatalogInputVariable v-for="(inputVariable, index) in inputVariables" :key="index" :variable="inputVariable" :readonly="readonly" @deleted="deleteInputVariable(index)"></FunctionCatalogInputVariable>
            </template>
        </template>
    </Card>
</template>
...
import FunctionCatalogInputVariable from './FunctionCatalogInputVariable.vue'

export default defineComponent({
    name: 'function-catalog-input-columns-card',
    components: { Card, FunctionCatalogInputVariable },
