<template>
    <DataTable
        ...
        :value="inputColumns"
        :editMode="functionCatalogDatasetFormColumnsTableDescriptor.editMode"
        :dataKey="functionCatalogDatasetFormColumnsTableDescriptor.dataKey"
        :responsiveLayout="functionCatalogDatasetFormColumnsTableDescriptor.responsiveLayout"
        :breakpoint="functionCatalogDatasetFormColumnsTableDescriptor.breakpoint"
    >
        ...
        <Column :header="$t('managers.functionsCatalog.datasetColumn')">
            <template #editor="slotProps">
                <Dropdown :style="functionCatalogDatasetFormColumnsTableDescriptor.dropdownStyle" class="p-mr-2" v-model="slotProps.data['datasetColumn']" :options="datasetColumns" />
                <i class="pi pi-pencil edit-icon" />
            </template>
            <template #body="slotProps">
                <span class="p-mr-2">{{ slotProps.data['datasetColumn'] }}</span>
                <i class="pi pi-pencil edit-icon" />
            </template>
        </Column>
    </DataTable>
...
import functionCatalogDatasetFormColumnsTableDescriptor from './FunctionCatalogDatasetFormColumnsTableDescriptor.json'
...
export default defineComponent({
    ...
    data() {
        return {
            functionCatalogDatasetFormColumnsTableDescriptor,
