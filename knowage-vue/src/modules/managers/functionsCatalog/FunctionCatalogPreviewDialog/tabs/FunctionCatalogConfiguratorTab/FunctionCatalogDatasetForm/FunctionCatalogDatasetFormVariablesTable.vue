<template>
    <DataTable
        ...
        :editMode="functionCatalogDatasetFormVariablesTableDescriptor.editMode"
        :dataKey="functionCatalogDatasetFormVariablesTableDescriptor.dataKey"
        :responsiveLayout="functionCatalogDatasetFormVariablesTableDescriptor.responsiveLayout"
        :breakpoint="functionCatalogDatasetFormVariablesTableDescriptor.breakpoint"
    >
        ...
        <Column :header="$t('managers.functionsCatalog.value')">
            <template #editor="slotProps">
                <InputText v-if="slotProps.data.type !== 'DATE'" :style="functionCatalogDatasetFormVariablesTableDescriptor.inputStyle" class="p-mr-2" v-model="slotProps.data['value']" :type="slotProps.data.type === 'NUMBER' ? 'number' : 'text'" />
...
import functionCatalogDatasetFormVariablesTableDescriptor from './FunctionCatalogDatasetFormVariablesTableDescriptor.json'
...
export default defineComponent({
    ...
    data() {
        return { functionCatalogDatasetFormVariablesTableDescriptor, inputVariables: [] as iInputVariable[] }
    },
    watch: {
        propinputColumns() {
