<template>
    <DataTable
        ...
        :value="rows"
        :paginator="true"
        :rows="functionCatalogPreviewTableDescriptor.rows"
        class="p-datatable-sm kn-table"
        v-model:filters="filters"
        filterDisplay="menu"
        :globalFilterFields="globalFilterFields"
        :responsiveLayout="functionCatalogPreviewTableDescriptor.responsiveLayout"
        :breakpoint="functionCatalogPreviewTableDescriptor.breakpoint"
    >
        <template #empty>
...
import functionCatalogPreviewTableDescriptor from './FunctionCatalogPreviewTableDescriptor.json'
...
export default defineComponent({
    ...
    data() {
        return {
            functionCatalogPreviewTableDescriptor,
            columns: [] as any[],
            rows: [] as any[],
