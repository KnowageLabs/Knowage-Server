...
export default defineComponent({
    ...
    methods: {
        async loadDatasets() {
            await this.$http.get(import.meta.env.VUE_APP_RESTFUL_SERVICES_PATH + '1.0/datasets/datasetsforlov/').then((response: AxiosResponse<any>) => (this.datasets = response.data))
        },
        loadDataset() {
