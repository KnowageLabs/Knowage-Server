    ...
    methods: {
        ...
        async openDocumentsSelectionDialog() {
            ...
            if (this.files.length === 0) {
                await this.$http.get(import.meta.env.VITE_RESTFUL_SERVICES_PATH + `scheduleree/folders/?includeDocs=true`).then((response: AxiosResponse<any>) => (this.files = response.data))
            }
        ...
        async loadDocumentInfo(documentLabel: string) {
            ...
            await this.$http.get(import.meta.env.VITE_RESTFUL_SERVICES_PATH + `1.0/documents/${documentLabel}`).then((response: AxiosResponse<any>) => (tempDocument = response.data))
            return tempDocument
        },
        ...
        async loadSelectedDocumentParameters(documentLabel: string) {
            ...
            await this.$http.get(import.meta.env.VITE_RESTFUL_SERVICES_PATH + `2.0/documents/${documentLabel}/parameters`).then((response: AxiosResponse<any>) => (tempParameters = response.data))
