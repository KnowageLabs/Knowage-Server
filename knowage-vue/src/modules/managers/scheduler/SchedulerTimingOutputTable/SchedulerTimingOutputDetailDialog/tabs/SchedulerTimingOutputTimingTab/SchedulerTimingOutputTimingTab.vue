            ...
            <div class="p-d-flex p-ai-center p-m-2" data-test="single-execution-trigger">
                <div class="p-col-5">
                    <span>
                        ...
                        <Calendar id="startDateTiming" class="kn-material-input custom-timepicker" :style="schedulerTimingOutputTimingTabDescriptor.style.calendarInput" v-model="trigger.startDateTiming" :showIcon="true" :manualInput="true" @input="setStartDate" @date-select="setStartDate" />
                    </span>
            ...
            <div v-if="triggerType === 'event'" class="p-d-flex p-ai-center p-m-2" data-test="event-trigger-endDate">
                <div class="p-col-5">
                    <span>
                        ...
                        <Calendar id="endDateTiming" class="kn-material-input custom-timepicker" :style="schedulerTimingOutputTimingTabDescriptor.style.calendarInput" v-model="trigger.endDateTiming" :showIcon="true" :manualInput="true" @input="setEndDate" @date-select="setEndDate" />
                    </span>
                    <div v-if="!validDates" class="p-error p-grid">
                        <small class="p-col-12">
                            {{ $t('managers.scheduler.dateError') }}
