<template>
    <Dialog class="p-fluid kn-dialog--toolbar--primary" :content-style="schedulerTimingOutputInfoDialogDescriptor.dialog.style" :visible="visible" :modal="true" :closable="false">
        <template #header>
