  ...
  <div class="kn-page">
    <div class="kn-page-content p-grid p-m-0">
            ...
            <div class="kn-list-item" data-test="list-item">
              <div class="kn-list-item-text">
                ...
                <span class="kn-list-item-text-secondary">{{
                  slotProps.option.dataType
                }}</span>
              </div>
              <Button
                icon="pi pi-trash"
                class="p-button-link p-button-sm"
                @click="deleteMetadataConfirm(slotProps.option.id)"
      ...
      <div class="kn-list--column p-col-8 p-sm-8 p-md-9 p-p-0">
        {{ metadataList }}
        <KnHint
          :title="'managers.metadata.title'"
          :hint="'managers.metadata.hint'"
          v-if="!formVisible"
        ></KnHint>
...
export default defineComponent({
  ...
  methods: {
    ...
    async deleteMetadata(metadataId: number) {
      await axios
        .delete(
          process.env.VUE_APP_RESTFUL_SERVICES_PATH + "2.0/objMetadata/" + metadataId
        )
        .then(() => {
