<template>
    <div class="p-d-flex p-flex-column kn-flex">
        <InlineMessage v-if="selectedAssociationProp.fields.length < 2" class="p-mt-3 p-mr-3" severity="error"> {{ $t('dashboard.datasetEditor.emptyAssociationError') }} </InlineMessage>
