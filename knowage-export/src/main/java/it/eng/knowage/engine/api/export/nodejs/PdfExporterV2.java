...
public class PdfExporterV2 extends AbstractNodeJSBasedExporter {
	...
	public PdfExporterV2(int documentId, String userId, String requestUrl, RenderOptions renderOptions,
			String pageOrientation, boolean pdfFrontPage, boolean pdfBackPage, String role, String organization, String params) throws EMFUserError, JSONException {
		super(documentId, userId, requestUrl, renderOptions, pageOrientation, pdfFrontPage, pdfBackPage, role, organization, params);
	}
