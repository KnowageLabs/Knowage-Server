...
,getCalendarNode : function(parentNode){
	for(var i=0;i<parentNode.attributes.children.length;i++){
		if(parentNode.attributes.children[i].attributes.iconCls=="calendar"){
			return parentNode.attributes.children[i];
		}
	}
	return null;
}
