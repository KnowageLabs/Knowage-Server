...
public class Router {
	...
	public void route(ServletContext servletContext, HttpServletRequest request, HttpServletResponse response)
		...
		TracerSingleton.log(Constants.NOME_MODULO, TracerSingleton.DEBUG, "Router::route: request.getContextPath() [" + request.getContextPath() + "]");
		TracerSingleton.log(Constants.NOME_MODULO, TracerSingleton.DEBUG, "Router::Router: _publisher [" + _publisher + "]");
		TracerSingleton.log(Constants.NOME_MODULO, TracerSingleton.DEBUG, "Router::Router: _isForward [" + _isForward + "]");
		...
		TracerSingleton.log(Constants.NOME_MODULO, TracerSingleton.DEBUG, "Router::route: publishingParameters [" + publishingParameters + "]");
		...
		if ((appendContextRoot == null) || (appendContextRoot.equalsIgnoreCase("TRUE")))
			if (_publisher.startsWith("/")) {
				TracerSingleton.log(Constants.NOME_MODULO, TracerSingleton.DEBUG, "Router::route: publisher assoluto");
				if (_isForward)
				...
				TracerSingleton.log(Constants.NOME_MODULO, TracerSingleton.DEBUG, "Router::route: publisher relativo");
				publishingURL = _publisher;
		...
		TracerSingleton.log(Constants.NOME_MODULO, TracerSingleton.DEBUG, "Router::route: publishingURL [" + publishingURL + "]");
		if (_isForward) {
