...
(function(){
	angular.module('advancedFiltersApp').directive('group', function(advancedFilterAppBasePath,$rootScope) {
		  return {
			  	scope:{
			  		node:'='
			  	},
			  	...
			  	restrict:'E',
			    templateUrl: advancedFilterAppBasePath + '/directives/group/group.html',
