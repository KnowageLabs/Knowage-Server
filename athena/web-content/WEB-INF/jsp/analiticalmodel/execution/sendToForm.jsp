...
<div class="div_form_container">
	<div class="div_form_margin">
		<div class="div_form_row">
			<div class='div_form_label'>
				<span class='portlet-form-field-label'> <spagobi:message
						key="sbi.execution.sendTo.a" />
				</span>
			</div>
			<div class='div_form_field'>
				<input id="sendtoto" class='portlet-form-input-field' type="text"
					name="a" size="50" value=""> &nbsp;*
			</div>
		</div>
		<div class="div_form_row">
			<div class='div_form_label'>
				<span class='portlet-form-field-label'> <spagobi:message
						key="sbi.execution.sendTo.cc" />
				</span>
			</div>
			<div class='div_form_field'>
				<input id="sendtocc" class='portlet-form-input-field' type="text"
					name="cc" size="50" value="">
			</div>
		</div>
		<div class="div_form_row">
			<div class='div_form_label'>
				<span class='portlet-form-field-label'> <spagobi:message
						key="sbi.execution.sendTo.object" />
				</span>
			</div>
			<div class='div_form_field'>
				<input id="sendtoobject" class='portlet-form-input-field'
					type="text" name="object" size="50" value="">
			</div>
		</div>
		<div class="div_form_row">
			<div class='div_form_label'>
				<span class='portlet-form-field-label'> <spagobi:message
						key="sbi.execution.sendTo.message" />
				</span>
			</div>
			<div class='div_form_field'>
				<textarea id="sendtomessage" class='portlet-form-input-field'
					name='message' cols='40' rows='10'></textarea>
			</div>
		</div>
		<br>
		<div class="div_form_row">
			...
			<span class='portlet-form-field-label'> <spagobi:message
					key="sbi.execution.sendTo.yourAccount" />
			</span>
		...
		<div class="div_form_row">
			<div class='div_form_label'>
				<span class='portlet-form-field-label'> <spagobi:message
						key="sbi.execution.sendTo.Login" />
				</span>
			</div>
			<div class='div_form_field'>
				<input id="sendtologin" class='portlet-form-input-field' type="text"
					name="login" size="50" value="">
		...
		<div class="div_form_row">
			<div class='div_form_label'>
				<span class='portlet-form-field-label'> <spagobi:message
						key="sbi.execution.sendTo.Password" />
				</span>
			</div>
			<div class='div_form_field'>
				<input id="sendtopwd" class='portlet-form-input-field'
					type="password" name="pwd" size="50" value="">
		...
		<div class="div_form_row">
			<div class='div_form_label'>
				<span class='portlet-form-field-label'> <spagobi:message
						key="sbi.execution.sendTo.ReplyTo" />
				</span>
			</div>
			<div class='div_form_field'>
				<input id="replyto" class='portlet-form-input-field' type="text"
					name="replyto" size="50" value="">
			</div>
		</div>
	</div>
</div>
...
<div>
	<div>
		<a style="text-decoration: none;" href='javascript:sendTo()'> <img
		...
		<div id="messageSendToDiv"
			style="font-size: 11px; font-family: arial; color: #074B88;"></div>
	</div>
</div>
