		...
		<div layout-padding layout="row" flex layout-fill class="h100" ng-controller="ActivityEventController as activityEvent">
			...
			<div layout="column" flex class="md-whiteframe-z1">
				<md-tabs ng-init="activityEvent.selectFirstEvent(jobDataCtrl.events)" flex>
					<md-tab id="eventTabDetail" layout-padding flex> <md-tab-label>{{translate.load("sbi.generic.details")}}</md-tab-label>
...
ng-init="activityEvent.month_week_number_repetition=activityEvent.month_week_number_repetition|| '1';">
					...
					<md-tab id="eventTabDocuments"> <md-tab-label>{{translate.load("sbi.scheduler.schedulation.events.documentsmanagement")}}</md-tab-label>
