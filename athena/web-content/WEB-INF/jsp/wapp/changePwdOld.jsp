      		...
      		<table border=0>
                  ...
                  <% if (("").equals(userId)) { %>        				  
        					...
        					<tr class='header-row-portlet-section'>
        						...
        						<input id="username" type="text" size="30" class="login" />
        						</td>	
        						<td></td>
        					</tr>	
      						<% } %>
      						...
      						<tr class='header-row-portlet-section'>
      						    <td>
      								<input id="oldPassword" type="password" size="30" class="login"/>
      							</td>	
      							<td>
      							</td>
      						</tr>
      						...
      						<tr>
      						   <td>
      								<input id="NewPassword" type="password" size="30" class="login"/>
      							</td>	
      							<td>
      							</td>
      						</tr>
      						...
      						<tr>
      						    <td>
      								<input id="NewPassword2" type="password" size="30" class="login"/>
      							</td>
      							<td>
      							</td>
      						</tr>
