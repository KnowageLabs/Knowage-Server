...
public class RestUtilitiesTest {
	...
	private final static Logger log = Logger.getLogger(RestUtilitiesTest.class);
	...
	public static void setProxyAddress(String proxyAddress) {
		RestUtilitiesTest.proxyAddress = proxyAddress;
	}
	...
	public static void setProxyPort(int proxyPort) {
		RestUtilitiesTest.proxyPort = proxyPort;
	}
	...
	public static String readBody(HttpServletRequest request) throws IOException {
		...
		return StringUtilities.readStream(inputStream);
	}
	...
	public static JSONObject readBodyAsJSONObject(HttpServletRequest request) throws IOException, JSONException {
		String requestBody = RestUtilitiesTest.readBody(request);
	...
	protected static List<NameValuePair> getAddressPairs(String address) {
		try {
			...
			for (String key : params.keySet()) {
				res.add(new NameValuePair(URIUtil.decode(key, StringUtilities.DEFAULT_CHARSET),
						URIUtil.decode(params.get(key), StringUtilities.DEFAULT_CHARSET)));
			}
			return res;
	...
	public static Map<String, String> getJSONHeaders() {
		...
		res.put(CONTENT_TYPE, APPLICATION_JSON);
		res.put(ACCEPT, APPLICATION_JSON);
		return res;
	}
