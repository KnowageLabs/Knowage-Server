...
public class CometServiceException extends SpagoBIRuntimeException {

	public CometServiceException(String message) {
		super(message);
	}

	public CometServiceException(String message, Throwable ex) {
		super(message, ex);
	}

	public CometServiceException(Throwable ex) {
		super(ex);
	}
