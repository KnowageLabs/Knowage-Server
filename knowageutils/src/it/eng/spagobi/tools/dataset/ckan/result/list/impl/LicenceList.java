...
import it.eng.spagobi.tools.dataset.ckan.resource.impl.Licence;
...
public class LicenceList extends CKANResult {
	private List<Licence> result;

	public List<Licence> getResult() {
		return result;
	}

	public void setResult(List<Licence> result) {
		this.result = result;
	}
}
