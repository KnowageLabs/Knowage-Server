...
public class ImportExportSDKServiceServiceLocator extends org.apache.axis.client.Service
		implements it.eng.spagobi.sdk.importexport.stub.ImportExportSDKServiceService {
	...
	private java.lang.String ImportExportSDKService_address = "http://localhost:8080/knowage/sdk/ImportExportSDKService";
	...
	@Override
	public it.eng.spagobi.sdk.importexport.stub.ImportExportSDKService getImportExportSDKService(java.net.URL portAddress)
			throws javax.xml.rpc.ServiceException {
		try {
			it.eng.spagobi.sdk.importexport.stub.ImportExportSDKServiceSoapBindingStub _stub = new it.eng.spagobi.sdk.importexport.stub.ImportExportSDKServiceSoapBindingStub(
					portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
		try {
			if (it.eng.spagobi.sdk.importexport.stub.ImportExportSDKService.class.isAssignableFrom(serviceEndpointInterface)) {
				it.eng.spagobi.sdk.importexport.stub.ImportExportSDKServiceSoapBindingStub _stub = new it.eng.spagobi.sdk.importexport.stub.ImportExportSDKServiceSoapBindingStub(
						new java.net.URL(ImportExportSDKService_address), this);
				_stub.setPortName(getImportExportSDKServiceWSDDServiceName());
				return _stub;
			}
