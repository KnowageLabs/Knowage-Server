...
public class CommunityFunctionalityConstants {
	 ...
	 */
	@Deprecated
	public static final String CREATE_CHART_FUNCTIONALITY = "CreateChartFunctionality";
	 ...
	 */
	@Deprecated
	public static final String FEDERATION_DEFINITION = "FederationDefinition";
	 ...
	 */
	@Deprecated
	public static final String GIS_WEB_DESIGNER = "GisWebDesigner";
	 ...
	 */
	@Deprecated
	public static final String NOTIFY_CONTEXT_BROKER_ACTION = "NotifyContextBrokerAction";
	 ...
	 */
	@Deprecated
	public static final String SELF_SERVICE_META_MODEL_MANAGEMENT = "SelfServiceMetaModelManagement";
	...
	public static final String VIEW_MY_FOLDER_ADMIN = "ViewMyFolderAdmin";
