...
public class PythonDataSetConstants {
	...
	public static final String IS_R_DATASET = "isRDataset";
	...
	public static final String[] PYTHON_STRING_ATTRIBUTES = { PYTHON_ADDRESS, PYTHON_ENVIRONMENT, PYTHON_SCRIPT, PYTHON_DATAFRAME_NAME, IS_R_DATASET,
