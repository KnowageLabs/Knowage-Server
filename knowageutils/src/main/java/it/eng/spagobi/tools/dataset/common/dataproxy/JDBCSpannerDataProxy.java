 ...
 */
public class JDBCSpannerDataProxy extends JDBCDataProxy {
	...
	private static Logger logger = Logger.getLogger(JDBCSpannerDataProxy.class);

	public JDBCSpannerDataProxy(int offsetParam, int fetchSizeParam) {
		this.setCalculateResultNumberOnLoad(true);
		this.offset = offsetParam;
		this.fetchSize = fetchSizeParam;
	}

	public JDBCSpannerDataProxy() {
		this.setCalculateResultNumberOnLoad(true);
	}

	public JDBCSpannerDataProxy(IDataSource dataSource, String statement, int offsetParam, int fetchSizeParam) {
		this(offsetParam, fetchSizeParam);
		setDataSource(dataSource);
		setStatement(statement);
	}

	public JDBCSpannerDataProxy(IDataSource dataSource, int offsetParam, int fetchSizeParam) {
		this(offsetParam, fetchSizeParam);
		setDataSource(dataSource);
		setStatement(statement);
	}

	public JDBCSpannerDataProxy(IDataSource dataSource) {
		setDataSource(dataSource);
	}
