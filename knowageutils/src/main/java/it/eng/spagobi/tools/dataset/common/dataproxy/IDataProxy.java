...
public interface IDataProxy {
	...
	/**
	 * Set if the calculation of the total result number is enabled or not. In case this calculation is required, invoke this method with true, otherwise with
	 * false.
	 */
	...
	Object getData(IDataReader dataReader, Object... resources);
}
