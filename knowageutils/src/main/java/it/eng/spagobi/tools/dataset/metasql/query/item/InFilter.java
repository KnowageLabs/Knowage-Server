...
public class InFilter extends MultipleProjectionSimpleFilter {

	private List<Object> operands;

	public InFilter(Projection projection, Object value) {
		this(Arrays.asList(projection), Arrays.asList(value));
	}

	public InFilter(Projection projection, List<Object> values) {
		this(Arrays.asList(projection), values);
	}

	public InFilter(List<Projection> projections, List<Object> values) {
		...
		this.operator = SimpleFilterOperator.IN;
