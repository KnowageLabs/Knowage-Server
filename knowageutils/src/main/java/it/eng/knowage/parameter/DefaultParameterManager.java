...
class DefaultParameterManager extends AbstractParameterManager {

	private static final Logger logger = LogManager.getLogger(DefaultParameterManager.class);

	private static final DefaultParameterManager INSTANCE = new DefaultParameterManager();

	public static DefaultParameterManager getInstance() {
		return INSTANCE;
	}

	private DefaultParameterManager() {
		super();
	}
