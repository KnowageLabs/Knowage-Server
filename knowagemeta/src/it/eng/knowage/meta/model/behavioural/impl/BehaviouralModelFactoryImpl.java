...
public class BehaviouralModelFactoryImpl extends EFactoryImpl implements BehaviouralModelFactory {
	...
	public static BehaviouralModelFactory init() {
		try {
			BehaviouralModelFactory theBehaviouralModelFactory = (BehaviouralModelFactory) EPackage.Registry.INSTANCE
					.getEFactory("http:///it/eng/knowage/meta/model/behavioural.ecore");
