...
public class JDBCTypeMapper {
	...
	private static boolean needArray(String modelType) {
		if ("BINARY".equals(modelType))
			return true;
		else if ("LONGVARBINARY".equals(modelType))
			return true;
	...
	public static Class getJavaType(String modelType) {
		...
		if ("ARRAY".equals(modelType))
			return java.sql.Array.class;
		else if ("BIGINT".equals(modelType))
			return java.lang.Long.class;
		else if ("BINARY".equals(modelType))
			return java.lang.Byte.class; // tolto []
		else if ("BIT".equals(modelType))
			return java.lang.Boolean.class;
		else if ("BLOB".equals(modelType))
			return java.sql.Blob.class;
		else if ("CHAR".equals(modelType))
			return java.lang.String.class;
		else if ("CLOB".equals(modelType))
			return java.sql.Clob.class;
		else if ("DATE".equals(modelType))
			return java.sql.Date.class;
		else if ("DECIMAL".equals(modelType))
			return java.math.BigDecimal.class;
		else if ("DISTINCT".equals(modelType))
			return java.lang.Object.class;
		else if ("DOUBLE".equals(modelType))
			return java.lang.Double.class;
		else if ("FLOAT".equals(modelType))
			return java.lang.Double.class;
		else if ("INTEGER".equals(modelType))
			return java.lang.Integer.class;
		else if ("JAVA_OBJECT".equals(modelType))
			return java.lang.Object.class;
		else if ("LONGVARBINARY".equals(modelType))
			return java.lang.Byte.class;// tolto []
		else if ("LONGVARCHAR".equals(modelType))
			return java.lang.String.class;
		else if ("NULL".equals(modelType))
			return java.lang.Object.class;
		else if ("NUMERIC".equals(modelType))
			return java.math.BigDecimal.class;
		else if ("OTHER".equals(modelType))
			return java.lang.Object.class;
		else if ("REAL".equals(modelType))
			return java.lang.Float.class;
		else if ("REF".equals(modelType))
			return java.sql.Ref.class;
		else if ("SMALLINT".equals(modelType))
			return java.lang.Short.class;
		else if ("STRUCT".equals(modelType))
			return java.sql.Struct.class;
		else if ("TIME".equals(modelType))
			return java.sql.Time.class;
		else if ("TIMESTAMP".equals(modelType))
			return java.sql.Timestamp.class;
		else if ("TINYINT".equals(modelType))
			return java.lang.Byte.class;
		else if ("VARBINARY".equals(modelType))
			return java.lang.Byte.class;// tolto []
