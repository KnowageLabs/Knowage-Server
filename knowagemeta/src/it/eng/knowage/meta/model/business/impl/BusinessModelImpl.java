 ...
 * <ul>
 * <li>{@link it.eng.knowage.meta.model.business.impl.BusinessModelImpl#getParentModel <em>Parent Model</em>}</li>
 * <li>{@link it.eng.knowage.meta.model.business.impl.BusinessModelImpl#getPhysicalModel <em>Physical Model</em>}</li>
 * <li>{@link it.eng.knowage.meta.model.business.impl.BusinessModelImpl#getTables <em>Tables</em>}</li>
 * <li>{@link it.eng.knowage.meta.model.business.impl.BusinessModelImpl#getRelationships <em>Relationships</em>}</li>
 * <li>{@link it.eng.knowage.meta.model.business.impl.BusinessModelImpl#getIdentifiers <em>Identifiers</em>}</li>
 * <li>{@link it.eng.knowage.meta.model.business.impl.BusinessModelImpl#getDomains <em>Domains</em>}</li>
...
public class BusinessModelImpl extends ModelObjectImpl implements BusinessModel {
	...
	@Override
	public void addBusinessView(BusinessView businessView) {
		businessView.setModel(this);

		String uniqueName = businessView.getName();
		uniqueName = uniqueName.replace("_", " ");
		uniqueName = uniqueName.trim().replace(" ", "_");
		uniqueName.toLowerCase();

		int index = 1;
		for (BusinessView bw : getBusinessViews()) {
			if (uniqueName.equals(bw.getUniqueName())) {
