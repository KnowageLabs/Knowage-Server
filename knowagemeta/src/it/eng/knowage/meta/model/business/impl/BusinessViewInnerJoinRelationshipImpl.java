...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Business View Inner Join Relationship</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link it.eng.knowage.meta.model.business.impl.BusinessViewInnerJoinRelationshipImpl#getModel <em>Model</em>}</li>
 * <li>{@link it.eng.knowage.meta.model.business.impl.BusinessViewInnerJoinRelationshipImpl#getSourceTable <em>Source Table</em>}</li>
 * <li>{@link it.eng.knowage.meta.model.business.impl.BusinessViewInnerJoinRelationshipImpl#getDestinationTable <em>Destination Table</em>}</li>
 * <li>{@link it.eng.knowage.meta.model.business.impl.BusinessViewInnerJoinRelationshipImpl#getSourceColumns <em>Source Columns</em>}</li>
 * <li>{@link it.eng.knowage.meta.model.business.impl.BusinessViewInnerJoinRelationshipImpl#getDestinationColumns <em>Destination Columns</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class BusinessViewInnerJoinRelationshipImpl extends ModelObjectImpl implements BusinessViewInnerJoinRelationship {
	...
	public BusinessModel getModel() {
		if (eContainerFeatureID() != BusinessModelPackage.BUSINESS_VIEW_INNER_JOIN_RELATIONSHIP__MODEL)
			return null;
	...
	public void setModel(BusinessModel newModel) {
		if (newModel != eInternalContainer()
				|| (eContainerFeatureID() != BusinessModelPackage.BUSINESS_VIEW_INNER_JOIN_RELATIONSHIP__MODEL && newModel != null)) {
		...
		if (sourceTable != null && sourceTable.eIsProxy()) {
			...
			if (sourceTable != oldSourceTable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BusinessModelPackage.BUSINESS_VIEW_INNER_JOIN_RELATIONSHIP__SOURCE_TABLE,
	...
	public void setSourceTable(PhysicalTable newSourceTable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BusinessModelPackage.BUSINESS_VIEW_INNER_JOIN_RELATIONSHIP__SOURCE_TABLE, oldSourceTable,
					sourceTable));
	}
	...
	public PhysicalTable getDestinationTable() {
		if (destinationTable != null && destinationTable.eIsProxy()) {
			...
			if (destinationTable != oldDestinationTable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BusinessModelPackage.BUSINESS_VIEW_INNER_JOIN_RELATIONSHIP__DESTINATION_TABLE,
	...
	public void setDestinationTable(PhysicalTable newDestinationTable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BusinessModelPackage.BUSINESS_VIEW_INNER_JOIN_RELATIONSHIP__DESTINATION_TABLE,
					oldDestinationTable, destinationTable));
	}
