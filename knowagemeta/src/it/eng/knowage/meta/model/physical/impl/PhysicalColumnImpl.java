 ...
 * <ul>
 * <li>{@link it.eng.knowage.meta.model.physical.impl.PhysicalColumnImpl#getComment <em>Comment</em>}</li>
 * <li>{@link it.eng.knowage.meta.model.physical.impl.PhysicalColumnImpl#getDataType <em>Data Type</em>}</li>
 * <li>{@link it.eng.knowage.meta.model.physical.impl.PhysicalColumnImpl#getTypeName <em>Type Name</em>}</li>
 * <li>{@link it.eng.knowage.meta.model.physical.impl.PhysicalColumnImpl#getSize <em>Size</em>}</li>
 * <li>{@link it.eng.knowage.meta.model.physical.impl.PhysicalColumnImpl#getOctectLength <em>Octect Length</em>}</li>
 * <li>{@link it.eng.knowage.meta.model.physical.impl.PhysicalColumnImpl#getDecimalDigits <em>Decimal Digits</em>}</li>
 * <li>{@link it.eng.knowage.meta.model.physical.impl.PhysicalColumnImpl#getRadix <em>Radix</em>}</li>
 * <li>{@link it.eng.knowage.meta.model.physical.impl.PhysicalColumnImpl#getDefaultValue <em>Default Value</em>}</li>
 * <li>{@link it.eng.knowage.meta.model.physical.impl.PhysicalColumnImpl#isNullable <em>Nullable</em>}</li>
 * <li>{@link it.eng.knowage.meta.model.physical.impl.PhysicalColumnImpl#getPosition <em>Position</em>}</li>
