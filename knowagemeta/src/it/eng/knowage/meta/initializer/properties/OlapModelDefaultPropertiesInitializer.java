 ...
 *
 */
public class OlapModelDefaultPropertiesInitializer implements IPropertiesInitializer {
	...
	private ModelPropertyCategory createPropertyCategoryIfNotExist(OlapModel o, String id, String name, String description) {
	...
	private ModelPropertyType createPropertyTypeIfNotExist(OlapModel o, ModelPropertyCategory category, String id, String name, String description, String defaultValue) {
	...
	private ModelProperty createProperty(OlapModel o, ModelPropertyType propertyType) {
