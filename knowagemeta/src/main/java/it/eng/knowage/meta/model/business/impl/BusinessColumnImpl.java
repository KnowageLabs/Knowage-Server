	...
	public void setIdentifier(boolean v) {
		if (true == v) {
			if (getTable().getIdentifier() != null) {
				...
				String name = "idx_" + System.currentTimeMillis();
				BusinessIdentifier identifier = BusinessModelFactory.eINSTANCE.createBusinessIdentifier();
				identifier.setModel(getTable().getModel());
				identifier.setTable(getTable());
				identifier.setUniqueName(name);
				identifier.setId(name);
				identifier.setName(name);
				identifier.getColumns().add(this);
