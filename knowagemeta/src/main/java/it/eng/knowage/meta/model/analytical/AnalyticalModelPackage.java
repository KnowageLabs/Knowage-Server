...
public interface AnalyticalModelPackage extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "http:///it/eng/knowage/meta/model/analytical.ecore";
	...
	/**
	 * The meta object id for the '{@link it.eng.knowage.meta.model.analytical.impl.AnalyticalModelImpl <em>Analytical Model</em>}' class. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The number of structural features of the '<em>Analytical Model</em>' class. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * Returns the meta object for class '{@link it.eng.knowage.meta.model.analytical.AnalyticalModel <em>Analytical Model</em>}'. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
