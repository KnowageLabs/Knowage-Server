...
/**
 * This class represent a sub entity that is an entity within a particular joining path.
 * 
 *
...
public class JpaSubEntity implements IJpaSubEntity {
	...
	/**
	 * First level entity = the root of the joining path. It can be a table or a view.
	 */
	Object root;
	/**
	 * The parent entity = the previous entity in the joining path. It's null if the previous entity is equal to the root entity
	 */
	JpaSubEntity parent;
	/**
	 * It's the relationship that link this entity with the previous one (i.e. the parent) in the joining path
	 */
