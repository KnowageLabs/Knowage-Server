...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Physical Foreign Key</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link it.eng.knowage.meta.model.physical.impl.PhysicalForeignKeyImpl#getSourceTable <em>Source Table</em>}</li>
 * <li>{@link it.eng.knowage.meta.model.physical.impl.PhysicalForeignKeyImpl#getSourceColumns <em>Source Columns</em>}</li>
 * <li>{@link it.eng.knowage.meta.model.physical.impl.PhysicalForeignKeyImpl#getSourceName <em>Source Name</em>}</li>
 * <li>{@link it.eng.knowage.meta.model.physical.impl.PhysicalForeignKeyImpl#getDestinationName <em>Destination Name</em>}</li>
 * <li>{@link it.eng.knowage.meta.model.physical.impl.PhysicalForeignKeyImpl#getDestinationTable <em>Destination Table</em>}</li>
 * <li>{@link it.eng.knowage.meta.model.physical.impl.PhysicalForeignKeyImpl#getDestinationColumns <em>Destination Columns</em>}</li>
 * <li>{@link it.eng.knowage.meta.model.physical.impl.PhysicalForeignKeyImpl#getModel <em>Model</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class PhysicalForeignKeyImpl extends ModelObjectImpl implements PhysicalForeignKey {
	...
	/**
	 * The default value of the '{@link #getSourceName() <em>Source Name</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getSourceName()
	 * @generated
	 * @ordered
	...
	/**
	 * The cached value of the '{@link #getSourceName() <em>Source Name</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getSourceName()
	 * @generated
	 * @ordered
	...
	/**
	 * The default value of the '{@link #getDestinationName() <em>Destination Name</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getDestinationName() <em>Destination Name</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getDestinationName()
	 * @generated
	 * @ordered
	...
	public PhysicalTable getSourceTable() {
		if (sourceTable != null && sourceTable.eIsProxy()) {
			...
			if (sourceTable != oldSourceTable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PhysicalModelPackage.PHYSICAL_FOREIGN_KEY__SOURCE_TABLE, oldSourceTable,
							sourceTable));
			}
		}
		return sourceTable;
	...
	public void setDestinationName(String newDestinationName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PhysicalModelPackage.PHYSICAL_FOREIGN_KEY__DESTINATION_NAME, oldDestinationName,
					destinationName));
	}
	...
	public PhysicalTable getDestinationTable() {
		if (destinationTable != null && destinationTable.eIsProxy()) {
			...
			if (destinationTable != oldDestinationTable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PhysicalModelPackage.PHYSICAL_FOREIGN_KEY__DESTINATION_TABLE,
	...
	public void setDestinationTable(PhysicalTable newDestinationTable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PhysicalModelPackage.PHYSICAL_FOREIGN_KEY__DESTINATION_TABLE, oldDestinationTable,
					destinationTable));
	}
	...
	public PhysicalModel getModel() {
		if (eContainerFeatureID() != PhysicalModelPackage.PHYSICAL_FOREIGN_KEY__MODEL)
			return null;
