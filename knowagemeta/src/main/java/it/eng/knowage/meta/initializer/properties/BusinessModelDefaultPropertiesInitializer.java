...
public class BusinessModelDefaultPropertiesInitializer implements IPropertiesInitializer {
	...
	private void initColumnProperties(SimpleBusinessColumn o) {
		...
		if (rootModel != null)
			propertyType = rootModel.getPropertyType(COLUMN_AGGTYPE);
		if (propertyType == null) {
			propertyType = FACTORY.createModelPropertyType();
		...
		if (rootModel != null)
			propertyType = rootModel.getPropertyType(COLUMN_DATATYPE);
		if (propertyType == null) {
			propertyType = FACTORY.createModelPropertyType();
			...
			propertyType.setDefaultValue("BOOLEAN");
		...
		// ALIGNMENT TYPE
		if (rootModel != null)
			propertyType = rootModel.getPropertyType(COLUMN_ALIGNMENT);
		if (propertyType == null) {
			propertyType = FACTORY.createModelPropertyType();
