...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Level</b></em>'. <!-- end-user-doc -->
 *
 * <p>
...
public interface Level extends ModelObject {
	/**
	 * Returns the value of the '<em><b>Hierarchy</b></em>' container reference. It is bidirectional and its opposite is '
	 * {@link it.eng.knowage.meta.model.olap.Hierarchy#getLevels <em>Levels</em>}'. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Hierarchy</em>' reference isn't clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link it.eng.knowage.meta.model.olap.Level#getHierarchy <em>Hierarchy</em>}' container reference. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Hierarchy</em>' container reference.
	 * @see #getHierarchy()
	 * @generated
	 */
	 ...
	 * <p>
	 * If the meaning of the '<em>Column</em>' reference isn't clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link it.eng.knowage.meta.model.olap.Level#getColumn <em>Column</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Returns the value of the '<em><b>Ordinal Column</b></em>' reference. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Ordinal Column</em>' reference isn't clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link it.eng.knowage.meta.model.olap.Level#getOrdinalColumn <em>Ordinal Column</em>}' reference. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Ordinal Column</em>' reference.
	...
	/**
	 * Returns the value of the '<em><b>Name Column</b></em>' reference. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Name Column</em>' reference isn't clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link it.eng.knowage.meta.model.olap.Level#getNameColumn <em>Name Column</em>}' reference. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Name Column</em>' reference.
	 * @see #getNameColumn()
	 * @generated
	 */
	...
	/**
	 * Returns the value of the '<em><b>Caption Column</b></em>' reference. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Caption Column</em>' reference isn't clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link it.eng.knowage.meta.model.olap.Level#getCaptionColumn <em>Caption Column</em>}' reference. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Caption Column</em>' reference.
	...
	/**
	 * Returns the value of the '<em><b>Property Columns</b></em>' reference list. The list contents are of type
	 * {@link it.eng.knowage.meta.model.business.BusinessColumn}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Property Columns</em>' reference list isn't clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
