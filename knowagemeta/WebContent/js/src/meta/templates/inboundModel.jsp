<md-dialog aria-label="Outboung Manager"   ng-cloak style="min-width:90%; min-height:90%;">
  <md-toolbar>
    ...
    <md-dialog-content flex> 
			...
			<associator-directive flex source-model="simpleLeft" target-model="simplRight" source-name="name" target-name="name" associated-item="links" translate="translate">
		 ...
		 <md-dialog-actions layout="row">
	             <span flex></span>
			      ...
			      <md-button ng-click="createInbound()">
			        Create
			      </md-button>
   			 </md-dialog-actions>
	</md-dialog>