...
.directive('list',
	...
	return {
		...
		'	<span class="extraListButtonContainer"></span>'+
...
.directive('extraListButton',
	...
	return {
		...
		link: function(scope, element, attrs, ctrl, transclude) {
			transclude(scope,function(clone,scope) {
				var contElem=element.parent()[0].querySelector(".kn-list md-toolbar .md-toolbar-tools .extraListButtonContainer ");
				angular.element(contElem).append(clone);
//				$compile(contElem)(scope);
			});
		}
