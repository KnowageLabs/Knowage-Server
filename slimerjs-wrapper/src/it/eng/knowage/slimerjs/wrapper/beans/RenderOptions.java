...
public class RenderOptions {
    ...
    public static final RenderOptions DEFAULT =
        EMPTY.withMargin(Margin.ZERO)
            .withDimensions(ViewportDimensions.VIEW_1600_1200)
            .withPaperSize(PaperSize.Letter)
            .withRenderFormat(RenderFormat.PNG)
            .withJavaScriptExecutionDetails(1000L, 100L)
            .withSlimerJSOptions(SlimerJSOptions.DEFAULT.withDiskCache(true));
    ...
    private RenderOptions(SlimerJSOptions options, PaperSize paperSize, ViewportDimensions dimensions, Margin margin, BannerInfo headerInfo, BannerInfo footerInfo, RenderFormat renderFormat, Long jsWait, Long jsInterval) {
