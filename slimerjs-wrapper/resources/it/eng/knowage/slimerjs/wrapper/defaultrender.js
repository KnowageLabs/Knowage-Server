...
var	jsRenderingWait = +system.args[ 9 ];
log("jsRenderingWait = " + jsRenderingWait);

var	jsExitingWait = +system.args[ 10 ];
log("jsExitingWait = " + jsExitingWait);
...
var applySettingOnPage = function applySettingOnPage(page, sheet, url) {
	...
	var hmacString = url + '' + uniqueToken + 'Authorization' + customHeaders.Authorization + hmacKey;
	log("HMAC String to be signed is: " + hmacString);
	var hmacSignature = sha256(hmacString);
	log("Signature " + hmacSignature);
	page.customHeaders = customHeaders;
	page.customHeaders.HMAC_Signature = hmacSignature;
	page.customHeaders.HMAC_Token = uniqueToken;
}
