...
public class TalendEngineConfig {
	...
	public String getEngineResourcePath() {
		...
		if (getEngineConfig().getResourcePath() != null) {
			path = getEngineConfig().getResourcePath() + File.separatorChar + "talend";
		} else {
	...
	public String getSpagoBIServerUrl() {
		...
		if (sourceBeanConf != null) {
			spagoBIServerURL = sourceBeanConf.getCharacters();
	...
	public String getSpagobiTargetFunctionalityLabel() {
		String label = null;
		SourceBean config = EnginConf.getInstance().getConfig();
		label = config.getCharacters("spagobi_functionality_label");
		return label;
	}
	...
	public String getSpagobiUrl() {
		/*
		 * String url = null; SourceBean config = EnginConf.getInstance().getConfig(); url= (String)config.getCharacters("spagobi_context_path"); return url;
		 */
	...
	public boolean isAutoPublishActive() {
		...
		SourceBean config = EnginConf.getInstance().getConfig();
		autoPublishProp = config.getCharacters("spagobi_autopublish");
		if (autoPublishProp != null && autoPublishProp.equalsIgnoreCase("true"))
			return true;
		return false;
	}
	...
	public String getJavaBinDir() {
		SourceBean config = EnginConf.getInstance().getConfig();
		String binDir = config.getCharacters("java_bin_dir");
	...
	public String getJavaCommand() {
		...
		String command = sbTmp.getCharacters();
	...
	public String getJavaCommandOption(String optionName) {
		SourceBean config = EnginConf.getInstance().getConfig();
		String commandOption = config.getCharacters("java_command_option_" + optionName);
	...
	public String getJobSeparator() {
		SourceBean config = EnginConf.getInstance().getConfig();
		String jobSeparator = config.getCharacters("jobSeparator");
		return jobSeparator;
	}
	...
	public String getPerlBinDir() {
		SourceBean config = EnginConf.getInstance().getConfig();
		String binDir = config.getCharacters("perl_bin_dir");
		return binDir;
	}
	...
	public String getPerlCommand() {
		SourceBean config = EnginConf.getInstance().getConfig();
		String command = config.getCharacters("perl_command");
		return command;
	}
	...
	public String getPerlExt() {
		SourceBean config = EnginConf.getInstance().getConfig();
		String ext = config.getCharacters("perlExt");
		return ext;
	}
	...
	public String getPerlInstallDir() {
		SourceBean config = EnginConf.getInstance().getConfig();
		String install = config.getCharacters("perl_install_dir");
		return install;
	}
	...
	public String getWordSeparator() {
		SourceBean config = EnginConf.getInstance().getConfig();
		String wordS = config.getCharacters("wordSeparator");
		return wordS;
	}
