(function() {
	...
	//	debugger;
		...
		if($scope.targetValue!=0){
			$scope.percentage = (($scope.value / $scope.targetValue)*100);
		}else{
			$scope.percentage = 0;
		}
		if($scope.precision){
			$scope.percentage = $scope.percentage.toFixed($scope.precision);
	...
	$scope.flagShowKValue = false;
	$scope.flagShowKTarget = false;
	//$scope.valueToShow=0;
	//$scope.targetToShow=0;
		$scope.data = 
			[{
/*	if($scope.value>=1000){
		$scope.valueToShow = $scope.value/1000;
		$scope.flagShowKValue = true;
	}else{
		$scope.valueToShow = $scope.value;
	}
	if($scope.targetValue>=1000){
		$scope.targetToShow = $scope.targetValue/1000;
		$scope.flagShowKTarget = true;
	}else{
		$scope.targetToShow = $scope.targetValue;
	}*/
