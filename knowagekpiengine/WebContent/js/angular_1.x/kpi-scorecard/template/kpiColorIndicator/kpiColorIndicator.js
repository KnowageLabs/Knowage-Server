...
.directive('kpiColorIndicator', ['$timeout','$mdDialog','sbiModule_translate','sbiModule_restServices','sbiModule_config','$filter','$mdSidenav', function($timeout,$mdDialog,sbiModule_translate,sbiModule_restServices,sbiModule_config,$filter,$mdSidenav){
	return {
		templateUrl: '/knowagekpiengine/js/angular_1.x/kpi-scorecard/template/kpiColorIndicator/kpiColorIndicatorTemplate.html',
		restrict: 'E',
		replace:true,
		scope: {
			perspectives:"=",
		...
		link: function(scope, element, attrs, ctrl, transclude) {
			...
			scope.addKpiToTarget=function(){ 
				...
				$mdDialog.show({
					...
					templateUrl: '/knowagekpiengine/js/angular_1.x/kpi-scorecard/template/kpiColorIndicator/kpiAddTemplate.html',
