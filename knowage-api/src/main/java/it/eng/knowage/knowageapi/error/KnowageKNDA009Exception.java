...
public class KnowageKNDA009Exception extends Exception {

	/*
	 * Error Code
	 */
	private String code = "KN-DA-009";
	 ...
	 */
	public KnowageKNDA009Exception(String message) {
		super(message);
	}
	 ...
	 */
	public KnowageKNDA009Exception(String message, Throwable ex) {
		super(message, ex);
	}
