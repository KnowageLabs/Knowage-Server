...
public class ImpossibleToDownloadFileException extends KnowageBusinessException {
	 ...
	 */
	public ImpossibleToDownloadFileException(String message) {
		super(message);
	}
	 ...
	 */
	public ImpossibleToDownloadFileException(String message, Throwable ex) {
		super(message, ex);
	}
