...
public class KnowageKNDA005Exception extends Exception {

	/*
	 * Error Code
	 */
	private String code = "KN-DA-005";
	 ...
	 */
	public KnowageKNDA005Exception(String message) {
		super(message);
	}
	 ...
	 */
	public KnowageKNDA005Exception(String message, Throwable ex) {
		super(message, ex);
	}
