...
public class KNRM011Exception extends KnowageBusinessException {
	 ...
	 */
	public KNRM011Exception(String message) {
		super(message);
	}
	 ...
	 */
	public KNRM011Exception(String message, Throwable ex) {
		super(message, ex);
	}
