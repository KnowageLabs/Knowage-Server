...
public class ImpossibleToReadFolderListException extends KnowageBusinessException {

	/*
	 * Status
	 */
	private Status status = Response.Status.NOT_FOUND;
	 ...
	 */
	private String description = "Impossible to read the folders list";
	 ...
	 */
	public ImpossibleToReadFolderListException(String message) {
		super(message);
	}
	 ...
	 */
	public ImpossibleToReadFolderListException(String message, Throwable ex) {
		super(message, ex);
	}
