...
public class KNRM004Exception extends KnowageBusinessException {

	/*
	 * Error Code
	 */
	private String code = "KN-RM-004";
	 ...
	 */
	public KNRM004Exception(String message) {
		super(message);
	}
	 ...
	 */
	public KNRM004Exception(String message, Throwable ex) {
		super(message, ex);
	}
