...
public class KnowageKNDA003Exception extends Exception {

	/*
	 * Error Code
	 */
	private String code = "KN-DA-003";
	 ...
	 */
	public KnowageKNDA003Exception(String message) {
		super(message);
	}
	 ...
	 */
	public KnowageKNDA003Exception(String message, Throwable ex) {
		super(message, ex);
	}
