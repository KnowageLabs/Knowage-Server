...
public class KnowageKNDA011Exception extends Exception {

	/*
	 * Error Code
	 */
	private String code = "KN-DA-011";
	 ...
	 */
	public KnowageKNDA011Exception(String message) {
		super(message);
	}
	 ...
	 */
	public KnowageKNDA011Exception(String message, Throwable ex) {
		super(message, ex);
	}
