...
public class KnowageKNDA004Exception extends Exception {

	/*
	 * Error Code
	 */
	private String code = "KN-DA-004";
	 ...
	 */
	public KnowageKNDA004Exception(String message) {
		super(message);
	}
	 ...
	 */
	public KnowageKNDA004Exception(String message, Throwable ex) {
		super(message, ex);
	}
