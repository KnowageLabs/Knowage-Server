...
public class SbiCommonInfo {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SbiCommonInfo other = (SbiCommonInfo) obj;
	...
	public String toString() {
		return "SbiCommonInfo [sbiVersionIn=" + sbiVersionIn + ", timeIn=" + timeIn + ", userIn=" + userIn + ", sbiVersionUp=" + sbiVersionUp + ", timeUp="
				+ timeUp + ", userUp=" + userUp + ", sbiVersionDe=" + sbiVersionDe + ", timeDe=" + timeDe + ", userDe=" + userDe + ", organization="
				+ organization + "]";
	}
