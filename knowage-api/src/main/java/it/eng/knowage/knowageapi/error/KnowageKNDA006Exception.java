...
public class KnowageKNDA006Exception extends Exception {

	/*
	 * Error Code
	 */
	private String code = "KN-DA-006";
	 ...
	 */
	public KnowageKNDA006Exception(String message) {
		super(message);
	}
	 ...
	 */
	public KnowageKNDA006Exception(String message, Throwable ex) {
		super(message, ex);
	}
