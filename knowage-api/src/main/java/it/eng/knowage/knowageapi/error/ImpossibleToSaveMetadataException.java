...
public class ImpossibleToSaveMetadataException extends KnowageBusinessException {
	 ...
	 */
	public ImpossibleToSaveMetadataException(String message) {
		super(message);
	}
	 ...
	 */
	public ImpossibleToSaveMetadataException(String message, Throwable ex) {
		super(message, ex);
	}
