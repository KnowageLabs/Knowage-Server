...
public class ImpossibleToReadFilesListException extends KnowageBusinessException {
	 ...
	 */
	public ImpossibleToReadFilesListException(String message) {
		super(message);
	}
	 ...
	 */
	public ImpossibleToReadFilesListException(String message, Throwable ex) {
		super(message, ex);
	}
