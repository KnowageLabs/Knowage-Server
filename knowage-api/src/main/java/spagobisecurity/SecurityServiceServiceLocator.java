...
public class SecurityServiceServiceLocator extends org.apache.axis.client.Service implements spagobisecurity.SecurityServiceService {
    ...
    private java.lang.String SecurityService_address = "http://localhost:8080/knowage/services/SecurityService";
    ...
    public spagobisecurity.SecurityService getSecurityService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            spagobisecurity.SecurityServiceSoapBindingStub _stub = new spagobisecurity.SecurityServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (spagobisecurity.SecurityService.class.isAssignableFrom(serviceEndpointInterface)) {
                spagobisecurity.SecurityServiceSoapBindingStub _stub = new spagobisecurity.SecurityServiceSoapBindingStub(new java.net.URL(SecurityService_address), this);
                _stub.setPortName(getSecurityServiceWSDDServiceName());
                return _stub;
            }
        }
